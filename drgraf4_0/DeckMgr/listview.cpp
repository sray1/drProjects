// samplvw.cpp : implementation of the CMeshDataView class
//
...
IMPLEMENT_DYNCREATE(CMeshDataView, CListView)

BEGIN_MESSAGE_MAP(CMeshDataView, CListView)
	//{{AFX_MSG_MAP(CMeshDataView)
	ON_WM_CREATE()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMeshDataView construction/destruction

CMeshDataView::CMeshDataView()
{
	m_nView		= VIEWMESHDATA;  // View12 = 1 etc.
}
...
/////////////////////////////////////////////////////////////////////////////
// CMeshDataView drawing

void CMeshDataView::OnDraw(CDC* pDC)
{
...
/////////////////////////////////////////////////////////////////////////////
// CMeshDataView diagnostics

#ifdef _DEBUG
void CMeshDataView::AssertValid() const
{
	CListView::AssertValid();
}

void CMeshDataView::Dump(CDumpContext& dc) const
{
	CListView::Dump(dc);
}

#endif //_DEBUG
CDaoViewDoc* CMeshDataView::GetDocument() // non-debug version is inline
{
...
/////////////////////////////////////////////////////////////////////////////
// CMeshDataView message handlers

int CMeshDataView::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CMeshDataView::ShowDatabase()
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowTableData(LPCTSTR strTableName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowTableSchema(LPCTSTR strTableDefName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowRelations(LPCTSTR strRelationName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowIndexes(LPCTSTR strTableName,LPCTSTR strIndexName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowQuerySchema(LPCTSTR strQueryDefName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::RunQueryDef(LPCTSTR strQueryDefName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowFields(LPCTSTR strTableName,LPCTSTR strFieldName)
{
	ASSERT(m_pDB);
	ASSERT(m_pDB->IsOpen());
...
void CMeshDataView::ShowFieldInfo(int nItem,CDaoFieldInfo& Info)
{
	CString strSize;
...
void CMeshDataView::ShowDatabaseInfo(int nItem,CDaoDatabaseInfo& Info)
{
	AddItem(nItem,0,Info.m_strName);
...
void CMeshDataView::ShowQueryDefInfo(int nItem,CDaoQueryDefInfo& Info)
{
...
void CMeshDataView::ShowTableDefInfo(int nItem,CDaoTableDefInfo& Info)
{
...
void CMeshDataView::ShowRelationInfo(int nItem,CDaoRelationInfo& Info)
{
...
void CMeshDataView::ShowIndexInfo(int nItem,CDaoIndexInfo& Info)
{
...
void CMeshDataView::DisplayColumnHeadings(UINT nStringID)
{
	CString strHeadings;
...
void CMeshDataView::AdjustColumnWidths()
{
	CListCtrlEx& ctlList = (CListCtrlEx&) GetListCtrl();
...
void CMeshDataView::AddItem(int nItem,int nSubItem,LPCTSTR strItem)
{
	CListCtrlEx& ctlList = (CListCtrlEx&) GetListCtrl();
