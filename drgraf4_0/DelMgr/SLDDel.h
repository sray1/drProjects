...
// CMouse view
//////////////////////////////////////////////////////
class CSLDDel : public CSupDel
{
public:

	CSLDDel();
//////////////////////////////////////
	DECLARE_SERIAL(CSLDDel)
//////////////////////////////////////
...
protected:
	...
	void			UpdateSLDeObjInfo();
	////////////////////////////////////////////////////////////////////////////////
	int				ShowStaticToBeDeleted(CDrStatic* pDrStatic, BOOL bToBeDeleted);
	int				MarkStatic_Delete(CDrStatic* pDrStatic);
	int				ShowWarning(char* buf,int& j, CString& ID);
	///////////////////////////////////////////////////////
	int				MarkNodeStatic_Delete(CDrNode* pDrNode, int nType, BOOL bToBeDeleted);
	int 			LeftUp_NodeStatic(CPoint point);
	///////////////////////////////////////////////////////
	int				MarkCurveStatic_Delete(CDrCurve* pDrCurve, int nType, BOOL bToBeDeleted);
	int				LeftUp_CurveStatic(CPoint point);
	///////////////////////////////////////////////////////
	int				MarkPatchStatic_Delete(CDrPatch* pDrPatch, int nType, BOOL bToBeDeleted);
	int				LeftUp_PatchStatic(CPoint point);
	///////////////////////////////////////////////////////
	int				MarkSolidStatic_Delete(CDrSolid* pDrSolid, int nType, BOOL bToBeDeleted);
