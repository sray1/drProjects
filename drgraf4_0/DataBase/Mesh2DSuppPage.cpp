// CMesh2DSuppPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CMesh2DSuppPage property page

IMPLEMENT_DYNCREATE(CMesh2DSuppPage, CPropertyPage)

CMesh2DSuppPage::CMesh2DSuppPage() : CPropertyPage(CMesh2DSuppPage::IDD)
{
	//{{AFX_DATA_INIT(CMesh2DSuppPage)
	m_bSkewed = FALSE;
	m_SuppType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
...
CMesh2DSuppPage::~CMesh2DSuppPage()
{
}

void CMesh2DSuppPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMesh2DSuppPage)
...
BEGIN_MESSAGE_MAP(CMesh2DSuppPage, CPropertyPage)
	//{{AFX_MSG_MAP(CMesh2DSuppPage)
	ON_CBN_SELCHANGE(IDC_SUPPCOMBO, OnSelchangeSuppcombo)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMesh2DSuppPage message handlers

BOOL CMesh2DSuppPage::OnInitDialog() 
{
...
int CMesh2DSuppPage::UpdateObjData(CString& strItemID)
{
...
int CMesh2DSuppPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CMesh2DSuppPage::OnSelchangeSuppcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CMesh2DSuppPage::FillLinearSupportInfo(CDrLinSup* pLinSup) 
{
...
void CMesh2DSuppPage::GetCreateBase(CString& strCreateBase,CDrLinSup* pSupp) 
{
...
void CMesh2DSuppPage::FillSuppType(SUPPPROC  suppproc) 
{
...
BOOL CMesh2DSuppPage::OnSetActive() 
{
