...
res\databaseDoc.ico
    ...
    for the CDatabaseDoc class.  This icon is included by the main
    resource file database.rc.
...
MakeHelp.bat
    Use this batch file to create your application's Help file, hlp\database.hLP.
