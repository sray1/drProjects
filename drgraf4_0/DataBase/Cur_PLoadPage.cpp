// CCur_PLoadPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CCur_PLoadPage property page

IMPLEMENT_DYNCREATE(CCur_PLoadPage, CPropertyPage)

CCur_PLoadPage::CCur_PLoadPage() : CPropertyPage(CCur_PLoadPage::IDD)
{
	//{{AFX_DATA_INIT(CCur_PLoadPage)
	m_LoadType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
	m_TY = 0.0;
...
CCur_PLoadPage::~CCur_PLoadPage()
{
}

void CCur_PLoadPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CCur_PLoadPage)
...
BEGIN_MESSAGE_MAP(CCur_PLoadPage, CPropertyPage)
	//{{AFX_MSG_MAP(CCur_PLoadPage)
...
/////////////////////////////////////////////////////////////////////////////
// CCur_PLoadPage message handlers

int CCur_PLoadPage::UpdateObjData(CString& strItemID)
{
	if(strItemID == "")
		return -1;
	////////////////////////
...
int CCur_PLoadPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CCur_PLoadPage::OnSelchangeStalcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CCur_PLoadPage::OnSelchangeSpelcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CCur_PLoadPage::OnSelchangeDynlcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CCur_PLoadPage::FillLinearStaticLoadInfo(CDrStatic* pStatic) 
{
...
void CCur_PLoadPage::GetCreateBase(CString& strCreateBase,CDrStatic* pStatic) 
{
...
void CCur_PLoadPage::FillLoadType(STALPROC  stalproc) 
{
...
BOOL CCur_PLoadPage::OnSetActive() 
{
