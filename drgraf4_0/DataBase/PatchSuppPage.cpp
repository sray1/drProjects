// CPatchSuppPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPatchSuppPage property page

IMPLEMENT_DYNCREATE(CPatchSuppPage, CPropertyPage)

CPatchSuppPage::CPatchSuppPage() : CPropertyPage(CPatchSuppPage::IDD)
{
	//{{AFX_DATA_INIT(CPatchSuppPage)
	m_bSkewed = FALSE;
	m_SuppType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
...
CPatchSuppPage::~CPatchSuppPage()
{
}

void CPatchSuppPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPatchSuppPage)
...
BEGIN_MESSAGE_MAP(CPatchSuppPage, CPropertyPage)
	//{{AFX_MSG_MAP(CPatchSuppPage)
	ON_CBN_SELCHANGE(IDC_SUPPCOMBO, OnSelchangeSuppcombo)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CPatchSuppPage message handlers

BOOL CPatchSuppPage::OnInitDialog() 
{
...
int CPatchSuppPage::UpdateObjData(CString& strItemID)
{
	if(strItemID == "")
		return -1;
	////////////////////////
...
int CPatchSuppPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CPatchSuppPage::OnSelchangeSuppcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CPatchSuppPage::FillLinearSupportInfo(CDrLinSup* pLinSup) 
{
...
void CPatchSuppPage::GetCreateBase(CString& strCreateBase,CDrLinSup* pSupp) 
{
...
void CPatchSuppPage::FillSuppType(SUPPPROC  suppproc) 
{
...
BOOL CPatchSuppPage::OnSetActive() 
{
