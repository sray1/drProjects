// CSolidLoadPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CSolidLoadPage property page

IMPLEMENT_DYNCREATE(CSolidLoadPage, CPropertyPage)

CSolidLoadPage::CSolidLoadPage() : CPropertyPage(CSolidLoadPage::IDD)
{
	//{{AFX_DATA_INIT(CSolidLoadPage)
	m_LoadType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
	m_TY = 0.0;
...
CSolidLoadPage::~CSolidLoadPage()
{
}

void CSolidLoadPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CSolidLoadPage)
...
BEGIN_MESSAGE_MAP(CSolidLoadPage, CPropertyPage)
	//{{AFX_MSG_MAP(CSolidLoadPage)
...
/////////////////////////////////////////////////////////////////////////////
// CSolidLoadPage message handlers

int CSolidLoadPage::UpdateObjData(CString& strItemID)
{
	if(strItemID == "")
		return -1;
	////////////////////////
...
int CSolidLoadPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CSolidLoadPage::OnSelchangeStalcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CSolidLoadPage::OnSelchangeSpelcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CSolidLoadPage::OnSelchangeDynlcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CSolidLoadPage::FillLinearStaticLoadInfo(CDrStatic* pStatic) 
{
...
void CSolidLoadPage::GetCreateBase(CString& strCreateBase,CDrStatic* pStatic) 
{
...
void CSolidLoadPage::FillLoadType(STALPROC  stalproc) 
{
...
BOOL CSolidLoadPage::OnSetActive() 
{
