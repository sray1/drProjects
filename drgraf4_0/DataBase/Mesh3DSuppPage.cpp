// CMesh3DSuppPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CMesh3DSuppPage property page

IMPLEMENT_DYNCREATE(CMesh3DSuppPage, CPropertyPage)

CMesh3DSuppPage::CMesh3DSuppPage() : CPropertyPage(CMesh3DSuppPage::IDD)
{
	//{{AFX_DATA_INIT(CMesh3DSuppPage)
	m_bSkewed = FALSE;
	m_SuppType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
...
CMesh3DSuppPage::~CMesh3DSuppPage()
{
}

void CMesh3DSuppPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMesh3DSuppPage)
...
BEGIN_MESSAGE_MAP(CMesh3DSuppPage, CPropertyPage)
	//{{AFX_MSG_MAP(CMesh3DSuppPage)
	ON_CBN_SELCHANGE(IDC_SUPPCOMBO, OnSelchangeSuppcombo)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMesh3DSuppPage message handlers

BOOL CMesh3DSuppPage::OnInitDialog() 
{
...
int CMesh3DSuppPage::UpdateObjData(CString& strItemID)
{
...
int CMesh3DSuppPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CMesh3DSuppPage::OnSelchangeSuppcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CMesh3DSuppPage::FillLinearSupportInfo(CDrLinSup* pLinSup) 
{
...
void CMesh3DSuppPage::GetCreateBase(CString& strCreateBase,CDrLinSup* pSupp) 
{
...
void CMesh3DSuppPage::FillSuppType(SUPPPROC  suppproc) 
{
...
BOOL CMesh3DSuppPage::OnSetActive() 
{
