// CPatchLoadPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CPatchLoadPage property page

IMPLEMENT_DYNCREATE(CPatchLoadPage, CPropertyPage)

CPatchLoadPage::CPatchLoadPage() : CPropertyPage(CPatchLoadPage::IDD)
{
	//{{AFX_DATA_INIT(CPatchLoadPage)
	m_LoadType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
	m_TY = 0.0;
...
CPatchLoadPage::~CPatchLoadPage()
{
}

void CPatchLoadPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CPatchLoadPage)
...
BEGIN_MESSAGE_MAP(CPatchLoadPage, CPropertyPage)
	//{{AFX_MSG_MAP(CPatchLoadPage)
...
/////////////////////////////////////////////////////////////////////////////
// CPatchLoadPage message handlers

int CPatchLoadPage::UpdateObjData(CString& strItemID)
{
	if(strItemID == "")
		return -1;
	////////////////////////
	...
	if(index<0)
		return 0;
	/////////////////////////////////////////
	m_pCurrentObject = (CDrPatch*)(pList->GetObject(index));
	///////////////////////
	if(m_pCurrentObject)
	{
		///
...
int CPatchLoadPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CPatchLoadPage::OnSelchangeStalcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CPatchLoadPage::OnSelchangeSpelcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CPatchLoadPage::OnSelchangeDynlcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CPatchLoadPage::FillLinearStaticLoadInfo(CDrStatic* pStatic) 
{
...
void CPatchLoadPage::GetCreateBase(CString& strCreateBase,CDrStatic* pStatic) 
{
...
void CPatchLoadPage::FillLoadType(STALPROC  stalproc) 
{
...
BOOL CPatchLoadPage::OnSetActive() 
{
