// CMesh3DLoadPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CMesh3DLoadPage property page

IMPLEMENT_DYNCREATE(CMesh3DLoadPage, CPropertyPage)

CMesh3DLoadPage::CMesh3DLoadPage() : CPropertyPage(CMesh3DLoadPage::IDD)
{
	//{{AFX_DATA_INIT(CMesh3DLoadPage)
	m_LoadType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
	m_TY = 0.0;
...
CMesh3DLoadPage::~CMesh3DLoadPage()
{
}

void CMesh3DLoadPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMesh3DLoadPage)
...
BEGIN_MESSAGE_MAP(CMesh3DLoadPage, CPropertyPage)
	//{{AFX_MSG_MAP(CMesh3DLoadPage)
...
/////////////////////////////////////////////////////////////////////////////
// CMesh3DLoadPage message handlers

int CMesh3DLoadPage::UpdateObjData(CString& strItemID)
{
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
	CDListMgr* pList		= pObjectMgr->GetObjectList(MESH3D);
	////////////////////////////////////////////////////////// 
	if(pList->GetCount()<=0)
		return 0;
	/////////////////////////////////////////
	int index = pList->GetObjectIndex(MESH3D,strItemID);	// ONLY for DrObject
	if(index<0)
		return 0;
	/////////////////////////////////////////
	m_pCurrentObject = (CDrMesh3D*)(pList->GetObject(index));
	///////////////////////
	if(m_pCurrentObject)
	{
		///
...
int CMesh3DLoadPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CMesh3DLoadPage::OnSelchangeStalcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CMesh3DLoadPage::OnSelchangeSpelcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CMesh3DLoadPage::OnSelchangeDynlcombo() 
{
	// TODO: Add your control notification handler code here
	
}

void CMesh3DLoadPage::FillLinearStaticLoadInfo(CDrStatic* pStatic) 
{
...
void CMesh3DLoadPage::GetCreateBase(CString& strCreateBase,CDrStatic* pStatic) 
{
...
void CMesh3DLoadPage::FillLoadType(STALPROC  stalproc) 
{
...
BOOL CMesh3DLoadPage::OnSetActive() 
{
