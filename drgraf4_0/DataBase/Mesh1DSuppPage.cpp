// CMesh1DSuppPage.cpp : implementation file
//
...
/////////////////////////////////////////////////////////////////////////////
// CMesh1DSuppPage property page

IMPLEMENT_DYNCREATE(CMesh1DSuppPage, CPropertyPage)

CMesh1DSuppPage::CMesh1DSuppPage() : CPropertyPage(CMesh1DSuppPage::IDD)
{
	//{{AFX_DATA_INIT(CMesh1DSuppPage)
	m_bSkewed = FALSE;
	m_SuppType = _T("");
	m_TX = 0.0;
	m_RX = 0.0;
...
CMesh1DSuppPage::~CMesh1DSuppPage()
{
}

void CMesh1DSuppPage::DoDataExchange(CDataExchange* pDX)
{
	CPropertyPage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMesh1DSuppPage)
...
BEGIN_MESSAGE_MAP(CMesh1DSuppPage, CPropertyPage)
	//{{AFX_MSG_MAP(CMesh1DSuppPage)
	ON_CBN_SELCHANGE(IDC_SUPPCOMBO, OnSelchangeSuppcombo)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CMesh1DSuppPage message handlers

BOOL CMesh1DSuppPage::OnInitDialog() 
{
...
int CMesh1DSuppPage::UpdateObjData(CString& strItemID)
{
...
int CMesh1DSuppPage::UpdateCombo(CDListMgr* pList, UINT DlgComboID)
{
	if(pList->IsEmpty())
		return 0;
	//////////////////
...
void CMesh1DSuppPage::OnSelchangeSuppcombo() 
{
	//////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CMesh1DSuppPage::FillLinearSupportInfo(CDrLinSup* pLinSup) 
{
...
void CMesh1DSuppPage::GetCreateBase(CString& strCreateBase,CDrLinSup* pSupp) 
{
...
void CMesh1DSuppPage::FillSuppType(SUPPPROC  suppproc) 
{
...
BOOL CMesh1DSuppPage::OnSetActive() 
{
