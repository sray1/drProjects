	...
	: CDialog(CDlg_Torq::IDD, pParent)
{
	...
	//}}AFX_DATA_INIT
	m_nLast		= 0;
//	m_pTwist = new double[m_nMaxTwist]; will be done in calling routine
	////////////////////////////////	
}
...
BOOL CDlg_Torq::OnInitDialog()
{
	...
	///////////////////////////////// How many Required
	char buf[20];
    sprintf(buf,"%d",(m_nMaxTwist - m_nLast) );
	m_strMore = buf; 
	//////////////////////////////
	FillListAllString(); 
	/////////////////
