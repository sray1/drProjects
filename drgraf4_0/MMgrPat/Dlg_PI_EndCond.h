#if !defined(AFX_DLG_ENDCOND_H__491FCC61_C71F_11D2_8B46_444553540000__INCLUDED_)
#define AFX_DLG_ENDCOND_H__491FCC61_C71F_11D2_8B46_444553540000__INCLUDED_
...
class CDlg_PI_EndCond : public CBasePage
{
	DECLARE_DYNCREATE(CDlg_PI_EndCond)

// Construction
public:
	CDlg_PI_EndCond();   // standard constructor
	CDlg_PI_EndCond(CWnd* pParentWnd,PATCHPROC PatProc);
...
// Dialog Data
	//{{AFX_DATA(CDlg_PI_EndCond)
	enum { IDD = IDD_PAT_IN_ENDCOND };
	CString		m_strBCL;
	CString		m_strBCR;
	BOOL		m_bRightOn;
	BOOL		m_bLeftOn;
