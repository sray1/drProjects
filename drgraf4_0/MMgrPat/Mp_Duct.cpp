				...
				) 
{
	...
	PatCNCoords_N_WtsAtJns(m_FromPt,
					...
					pTwist,pPatConsJn,pPatWtsJn,nTotConsJn_T);
	/////////////////////////////////////////////////////////////////////////////// PostPatchData
...
int CMP_Duct::GetCNodeCoords_N_Wts_XSection(CDrCurve* pCurve, CURVELATCH cLatch, 
...
//////////////////////////////////////////////////////////////////////////////////////
int CMP_Duct::GetCNodeCoords_N_WtsAtJnPts_Spine(CDrCurve* pCurve, CURVELATCH cLatch, 
									pWORLD pConOld, pDOUBLE pWtsOld)
{
...
int CMP_Duct::CreateTangentsAtJnPts_Spine(CDrCurve* pCurve,CURVELATCH cLatch,pWORLD pTangents)
{
...
int CMP_Duct::PatCNCoords_N_WtsAtJns(WORLD wAnchorPt,pWORLD pConBZ_S,pDOUBLE pWtsBZ_S,int nConBZ_S,
...
int CMP_Duct::PostPatBezInfoUsingBlendingInfo(CDrPatch* pPatch,CDrCurve* pSpineCurve,
												pWORLD pConBZ,pDOUBLE pWtsBZ,int nConBZ,
													int nCurves/*nConBZJn_T*/,int nCon_T)
{
...
int CMP_Duct::PostPatBezInfo(CDrPatch* pPatch,CDListMgr& TemCNodeList,pDOUBLE pTemPatWts_BZ,
...
int CMP_Duct::TempPostPatBezJunctionPtsInINodeList(pWORLD pConBZ,int nConBZ,int nCol,
...
int CMP_Duct::PackPatBezJunctionWtsInDataWtsArray(pDOUBLE pWtsBZ,int nConBZ,int nCol,
...
int CMP_Duct::GeneratePatchBezInfoFromSpineCurve(
...
int CMP_Duct::Copy_N_TransferBezControlInfo(CDrCurve* pCurve,CDListMgr* pPatCNodeList,
...
int CMP_Duct::Copy_N_TransferBezWeightInfo(CDrCurve* pCurve,pDOUBLE pPatWts_BZ,int nCon_T,int nCol)
{
	pDOUBLE pWts	= pCurve->GetpWts_BZ_S(); 
...
int CMP_Duct::CreateFillCNodeList_N_Wts_S(CDrPatch* pDrPatch,int iCurve_U,int nDegree_T,
...
int CMP_Duct::PackCNodeList_N_Wts_S(CString& PatchID,CDListMgr* pPatCNodeList,pDOUBLE pPatWts,
...
///////////////////////////////////////////////////////////////////////////////////////////
int CMP_Duct::LatticeCurves_V(CDrPatch* pDrPatch,int nOrder_S,BOOL bClosed_S,int nSegBZ_S,
...
int CMP_Duct::CreateFillCNodeList_N_Wts_T(CDrPatch* pDrPatch,int iCurve_V,int nDegree_S,
...
int CMP_Duct::PackCNodeList_N_Wts_T(CString& PatchID,CDListMgr* pPatCNodeList,pDOUBLE pPatWts,
...
int CMP_Duct::CreateFillINodeList_T(CDrPatch* pDrPatch,int iCurve_V,int nINode_V/*BzJnPts_S*/,
					int nDegree_S,int nDegree_T,int nConBZ_S,CDListMgr* pINodeList)
{
	int nResult;
	//////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
int CMP_Duct::SetDataFromCurve_Lattice(CDrCurve* pCurve)
{
	int i;
	pINT	pNum_t_S;
	pDOUBLE	pDis_t_S;
...
int CMP_Duct::SetInfoDataBase_LatticeCurve(CDrCurve* pDrObject)
{
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
void CMP_Duct::SetInfo_LatticeCurve(CDrCurve* pDrObject)
{
	///////////////////////////////////////////////////////////////// All Other
	pDrObject->SetRatio_S(m_Ratio_S);					
	pDrObject->SetUniform_S(m_bUnifOT_S);		// Output Distribution:
