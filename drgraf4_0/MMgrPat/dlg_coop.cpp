...
CDlg_CooP::CDlg_CooP(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_CooP::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_CooP)
	m_PatchID 	= "";
	m_CID_1 	= "";
	m_CID_2 	= "";
	m_CID_3 	= "";
...
void CDlg_CooP::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_CooP)
	...
	DDX_CBString(pDX, IDC_ORIENT_4, m_Orient_4);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CDlg_CooP, CDialog)
	//{{AFX_MSG_MAP(CDlg_CooP)
	...
	ON_CBN_SELCHANGE(IDC_CID_4, OnSelchangeCid4)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_CooP message handlers
BOOL CDlg_CooP::OnInitDialog()
{
...
*/
	...
	///////////////////////////////////////////////////////////////////
 	...
 	((CComboBox*)GetDlgItem(IDC_ORIENT_4))->SetCurSel(1);//Backward=0/Forward=1
	/////////////////
...
void CDlg_CooP::OnSelchangeCid1() 
{
    ////////////////////
...
void CDlg_CooP::OnSelchangeCid2() 
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_CooP::OnSelchangeCid3() 
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_CooP::OnSelchangeCid4() 
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_CooP::FillListAllPatchIDs()
{
...
void CDlg_CooP::FillListAllCurveIDs()
{
...
void CDlg_CooP::SetInfoForDataBase(CDrPatch* pDrObject)
{
	...
	pDrObject->SetCurveID(m_CID_4,3);
	/////////////////////////////////
