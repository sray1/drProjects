...
/////////////////////////////////////////////////////////////////////////////
// CDlg_PI_Duct dialog
IMPLEMENT_DYNCREATE(CDlg_PI_Duct, CBasePage)

CDlg_PI_Duct::CDlg_PI_Duct(): CBasePage()
{
}

CDlg_PI_Duct::CDlg_PI_Duct(CWnd* pMainWnd,PATCHPROC PatProc)
				: CBasePage(pMainWnd,PatProc,CDlg_PI_Duct::IDD)
{
	//{{AFX_DATA_INIT(CDlg_PI_Duct)
	m_dCoord	= 0.0;
	m_bTwist	= TRUE;
	m_TwistMult	= 1.0;
	//}}AFX_DATA_INIT
...
CDlg_PI_Duct::~CDlg_PI_Duct()
{
}

void CDlg_PI_Duct::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_PI_Duct)
...
BEGIN_MESSAGE_MAP(CDlg_PI_Duct, CBasePage)
	//{{AFX_MSG_MAP(CDlg_PI_Duct)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_PI_Duct message handlers
BOOL CDlg_PI_Duct::OnInitDialog()
{
...
void CDlg_PI_Duct::OnSelchangePid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_PI_Duct::OnSelchangeCid() 
{
    ////////////////////
...
void CDlg_PI_Duct::OnSelchangeNid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_PI_Duct::OnUpdate()
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////////////////////////////////
...
void CDlg_PI_Duct::FillListAllString_Patch()
{
...
void CDlg_PI_Duct::FillListAllString_Curve()
{
...
void CDlg_PI_Duct::FillListAllString_Node()
{
