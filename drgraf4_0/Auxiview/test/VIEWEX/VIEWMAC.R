...
resource 'hovr' (1000)
{
    HelpMgrVersion, hmDefaultOptions, 0, 0,
        ...
        {
            "Miscellaneous part of the Microsoft Viewex "
            "Sample Application."
        },
        {
            ...
            {
                "Click here to close the Microsoft Viewex "
                "Sample Application."
            },
            ...
            {
                "This is not part of the Microsoft Viewex "
...
resource 'STR ' (500)
{
	"This is the Win32 Viewex sample application "
