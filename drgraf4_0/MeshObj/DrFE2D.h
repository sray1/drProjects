...
/////////////////////////////////////////////////////////////////////////////
// CDrFE2D    ///////////////////////////////////////////////////////////////
class AFX_EXT_CLASS CDrFE2D: public CDrFE1D
{
public:
// Construction                 
	CDrFE2D();
//////////////////////////////////////
	DECLARE_SERIAL(CDrFE2D);
//////////////////////////////////////
...
public:
	...
	virtual BOOL 		IsObjectHit(int nNet,POINT point,int startIndex);
	...
	void				SetnNodes(short s){m_nNodes = s;};		
 	short				GetnEdgeNodes(){return m_nEdgeNodes;};		
	void				SetnEdgeNodes(short s){m_nEdgeNodes = s;};		
	///
...
*///082898
	BOOL				IsPosiEdge(int index){return m_bPosiEdge[index];};
	void				SetPosiEdge(int index,BOOL bPos){m_bPosiEdge[index] = bPos;};
	////////////////////////////////////////////////////////
...
// Attributes
	...
	short		m_nEdgeNodes;		// intermediate Edge + corner Nodes or Vertices
	short		m_nNodes;			// intermediate + Edge Nodes = ALL
//	short		m_nEdgeDegree;		// 1 = Linear/ 2 = Quadratic etc
	...
	POINT 		m_nCenter; 
	////////////////////////////////////////// Data Structure
//	CDListMgr	m_FE0DList;	// All Vrtxs connected to this Face 
//	CDListMgr	m_FE1DList;	// All Edges connected to this Face
//	CDListMgr	m_FE3DList;	// All Cubes connected to this Face
	////////////////////////////////////////// Genetics
//082898	UINT		m_GenObjType;				// Mesh0D,Mesh1D,Mesh2D or Mesh3D
//082898	CDrObject*	m_pGenObj;
	////////////////////////////////////////// Mesh Manipulation
	BOOL		m_bPosiEdge[MAX_EDGES_2D];	// Is Edge Positive Oriented
	///////////////////////////////// Render 
    BOOL		m_bCulled;
