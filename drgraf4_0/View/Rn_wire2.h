...
/////////////////////
class AFX_EXT_CLASS CWire_2 : public CRender
{
// Construction
public:  
	CWire_2();
...
protected:
	...
	virtual int		RenderSORTLIST
					(
						CClientDC* pDC,CRect& RectClip,int nActiveObjType, int nActiveObjIndex
					);

	virtual int		RenderCLIPPOLY(CClientDC* pDC,POINT* N2DPos,
										int nMaxN,BOOL bSelected);
	virtual int		ClipPoly(CDrObject* pObject,pWORLD NodeEye);

	virtual	int		RenderSTRAY(CClientDC* pDC,CDrObject* pObject,
							BOOL bSelected,int nViewNum);
	///////////////////////////////////////////
	virtual	void	RenderReadyOBJECT(CDC* pDC,CDrObject* pObject,int nObjectType);
						
protected:


	CDListMgr*	m_pPolyList;
	double		m_dShrink;
	/////////////////////////////////////////// ViewNumber
    int 		m_nView;
	/////////////////////////////////////////// Document Size
