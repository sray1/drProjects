// DVM_Edit.cpp : implementation of the CDVM_Edit class         BASE Class
//
...
IMPLEMENT_DYNCREATE(CDVM_Edit, CObject)

/////////////////////////////////////////////////////////////////////////////
// CDVM_Edit


void CDVM_Edit::MouseMove(CView* pDrawView, UINT nFlags, CPoint point)
{
	...
	//////////////////////////////////////////
	pWnd->GetEditMgr()->SetViewCursor(pView->GetViewNum());
	////////////////////////////////////////////////
	if(pWnd->IsIGenBoxActive())
	{
		...
		switch(pWnd->GetMouseBoxType())
		{
			case ELEMDIMBOX:
			case NODEBOX:
				pWnd->GetEditMgr()->GetDLDMouse()->SetViewNumber(pView->GetViewNum());    // View12 = 1 etc.
				pWnd->GetEditMgr()->GetDLDMouse()->
...
void CDVM_Edit::LButtonDown(CView* pDrawView, UINT nFlags, CPoint point)
{
...
void CDVM_Edit::LButtonUp(CView* pDrawView, UINT nFlags, CPoint point)
{
...
void CDVM_Edit::RButtonDown(CView* pDrawView, UINT nFlags, CPoint point)
{ 
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CDrawView* pView	= (CDrawView*)pDrawView;
	CClientDC	dc(pView);
...
void CDVM_Edit::RButtonUp(CView* pDrawView, UINT nFlags,CPoint point)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CDrawView* pView	= (CDrawView*)pDrawView;
	CClientDC	dc(pView);
