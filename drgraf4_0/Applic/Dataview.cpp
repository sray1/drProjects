...
IMPLEMENT_DYNCREATE(CDataView, CRowView)
...
BEGIN_MESSAGE_MAP(CDataView, CRowView)
...
void CDataView::OnUpdate(CView*, LPARAM lHint, CObject* pHint)
{
...
void CDataView::GetRowWidthHeight(CDC* pDC, int& nRowWidth, int& nRowHeight)
{
	/////////////////////////////////////////////////////////////////// Deck Not Empty
...
void CDataView::ChangeSelectionNextRow(BOOL bNext)
{
	CDrGrafDoc* pDoc = GetDocument();
	CObjectMgr* pObjectMgr = pDoc->GetObjectMgr();
...
void CDataView::ChangeSelectionToRow(int nRow)
{
	CDrGrafDoc* pDoc = GetDocument();
	CObjectMgr* pObjectMgr = pDoc->GetObjectMgr();
...
void CDataView::OnDrawRow(CDC* pDC, int nRow, int y, BOOL bSelected)
{
...
void CDataView::OnLButtonDown(UINT, CPoint point)
{
	CClientDC dc(this);
	OnPrepareDC(&dc);
	dc.DPtoLP(&point);
...
//	CRowView::OnLButtonDown(nFlags, point);  //sets active Index
	...
	pWnd->SetActiveViewNumber(VIEWDAT);
	///////////////////
	CDrGrafDoc* pDoc = GetDocument();
	CObjectMgr* pObjectMgr = pDoc->GetObjectMgr();
...
{ 
	///////////////////////////////////// if NodeDlg Open
	CDrGrafFrame* pWnd = (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	if(pWnd->GetActiveViewNumber() != VIEWDAT)
	{
		pWnd->SetActiveViewNumber(VIEWDAT);
		//////////////////////////
	}
