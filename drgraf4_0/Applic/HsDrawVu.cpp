// drgravw.cpp : implementation of the CHsDrawVu class
//
...
IMPLEMENT_DYNCREATE(CHsDrawVu, CAxDrawVu)

BEGIN_MESSAGE_MAP(CHsDrawVu, CAxDrawVu)
	//{{AFX_MSG_MAP(CHsDrawVu)
	ON_WM_SETFOCUS()
...
/////////////////////////////////////////////////////////////////////////////
// CHsDrawVu construction/destruction
...
void CHsDrawVu::OnInitialUpdate()
{
	///////////////////////////////////////////
...
void CHsDrawVu::OnUpdate(CView* pSender, LPARAM lHint, CObject* pHint)
{
...
int CHsDrawVu::GetActiveObjectIndex()
{
	CDrGrafDoc* pDoc = GetDocument();
	return (pDoc->GetAxObjMgr()->GetActiveRowIndex());		//june96
}

int CHsDrawVu::GetObjectCount()
{
	CDrGrafDoc* pDoc = GetDocument();
	return (pDoc->GetAxObjMgr()->GetRowCount());			//june96
} 

void CHsDrawVu::ChangeSelectionNextObjectIndex(BOOL bNext)
{
	CDrGrafDoc* pDoc = GetDocument();
	pDoc->GetAxObjMgr()->ChangeSelectionNextObjectIndex(bNext);
}

void CHsDrawVu::ChangeSelectionToObjectIndex(int nObjectIndex)
{
	CDrGrafDoc* pDoc = GetDocument();
	pDoc->GetAxObjMgr()->ChangeSelectionToObjectIndex(nObjectIndex);
} 

void CHsDrawVu::OnDrawObject(CDC* pDC, int nObjIndex,int nObjectType, BOOL bSelected)
{
	CDrGrafDoc* pDoc = GetDocument();
...
BOOL CHsDrawVu::OnPreparePrinting(CPrintInfo* pInfo)
{
	// default preparation
	return DoPreparePrinting(pInfo);
}

void CHsDrawVu::OnBeginPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
	// TODO: add extra initialization before printing
}

void CHsDrawVu::OnEndPrinting(CDC* /*pDC*/, CPrintInfo* /*pInfo*/)
{
...
BOOL CHsDrawVu::IsSelected(const CObject* pDocItem) const
{
...
void CHsDrawVu::OnCancelEditCntr()
{
...
void CHsDrawVu::OnSetFocus(CWnd* pOldWnd)
{ 
	///////////////////////////////////////////////////////////////////////// OLE
	COleClientItem* pActiveItem = GetDocument()->GetInPlaceActiveItem(this);
	if (pActiveItem != NULL &&
...
int CHsDrawVu::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
	///////////////////////////////////// if NodeDlg Open
	CDrGrafFrame* pWnd = (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	if(pWnd->GetActiveViewNumber() != VIEWSPECTRA_IN)
...
void CHsDrawVu::OnCancelEditSrvr()
{
	GetDocument()->OnDeactivateUI(FALSE);
}

/////////////////////////////////////////////////////////////////////////////
// CHsDrawVu diagnostics

#ifdef _DEBUG
void CHsDrawVu::AssertValid() const
{
	CScrollView::AssertValid();
}

void CHsDrawVu::Dump(CDumpContext& dc) const
{
	CScrollView::Dump(dc);
}

CDrGrafDoc* CHsDrawVu::GetDocument() // non-debug version is inline
{
...
/////////////////////////////////////////////////////////////////////////////
// CHsDrawVu message handlers

int CHsDrawVu::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
///////////////////////////////////////////////////// Mouse Manipulation
void CHsDrawVu::OnMouseMove(UINT nFlags, CPoint point)
{
	MouseMove(nFlags,point);
}

void CHsDrawVu::OnLButtonDown(UINT nFlags, CPoint point)
{
	LButtonDown(nFlags,point);
}

void CHsDrawVu::OnLButtonUp(UINT nFlags, CPoint point)
{
	LButtonUp(nFlags,point);
}

void CHsDrawVu::OnRButtonDown(UINT nFlags, CPoint point)
{ 
	RButtonDown(nFlags,point);
}
		
void CHsDrawVu::OnRButtonUp(UINT nFlags, CPoint point)
{
