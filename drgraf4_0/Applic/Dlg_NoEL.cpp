...
CDlg_NoELem::CDlg_NoELem(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_NoELem::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_NoELem)
	m_bNone		= TRUE;
	m_bAll		= FALSE;
	m_bBallJt	= FALSE;
	m_bBeam		= FALSE;
...
void CDlg_NoELem::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_NoELem)
...
BEGIN_MESSAGE_MAP(CDlg_NoELem, CDialog)
	//{{AFX_MSG_MAP(CDlg_NoELem)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_NoELem message handlers

BOOL CDlg_NoELem::OnInitDialog()
{
