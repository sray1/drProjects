...
CDlg_F_MA::CDlg_F_MA(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_F_MA::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_F_MA)
	m_CID			= _T("");
	m_bIncrement	= FALSE;
	m_Orient		= _T("");
	m_dScale		= 0.0;
...
void CDlg_F_MA::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_F_MA)
...
BEGIN_MESSAGE_MAP(CDlg_F_MA, CDialog)
	//{{AFX_MSG_MAP(CDlg_F_MA)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_F_MA message handlers

BOOL CDlg_F_MA::OnInitDialog()
{
...
void CDlg_F_MA::OnTangent() 
{
	...
	else
	{
		...
		GetDlgItem(IDC_NIDHEAD)->SetWindowText("CNID");
	}
}

void CDlg_F_MA::OnIncrement() 
{
    ////////////////////
...
void CDlg_F_MA::FillListAllCurveIDs()
{
...
/*
void CDlg_F_MA::SetInfoForDataBase(CDrPatch* pDrObject)
{
