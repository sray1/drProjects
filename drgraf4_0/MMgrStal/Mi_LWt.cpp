...
////////////////////////////////////
IMPLEMENT_SERIAL(CMI_LWt,CMI_GangS,1)
/////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////// Poting Helper
CDrLWt* CMI_LWt::CreateCurveBased(CString& LoadID, CDrCurve* pCurve,
...
/*
	...
	if(nActiveIndex>=0)
	{
		pAdd = (CDrLWt*)pDListMgr->GetObject(nActiveIndex);
...
*/
	...
	{
	    pAdd = (CDrLWt*)(pObjectMgr->AddToDataBase(nActiveIndex,FORCE));
		///////////////////////////////////////////// init Raw StaL Data
		pAdd->InitRawData();
		/////////////////////
...
CDrLWt* CMI_LWt::CreateNodeBased(CString& LoadID, CDrNode* pNode,
						double Tx,double Ty,double Tz,CString& aNid, UINT StaLBased)
{
...
void CMI_LWt::SetInfoForBase(CDrLWt* pStaL)
{
...
void CMI_LWt::Serialize(CArchive& ar)
{
