...
////////////////////////////////////
IMPLEMENT_SERIAL(CMI_D_R,CMI_GangS,1)
/////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////// Poting Helper
CDrD_R* CMI_D_R::CreateCurveBased(CString& LoadID, CDrCurve* pCurve,
...
/*
	...
	if(nActiveIndex>=0)
	{
		pAdd = (CDrD_R*)pDListMgr->GetObject(nActiveIndex);
...
*/
	...
	{
	    pAdd = (CDrD_R*)(pObjectMgr->AddToDataBase(nActiveIndex,FORCE));
		///////////////////////////////////////////// init Raw StaL Data
		pAdd->InitRawData();
		/////////////////////
...
CDrD_R* CMI_D_R::CreateNodeBased(CString& LoadID, CDrNode* pNode,
						double Tx,double Ty,double Tz,double Rx,double Ry,double Rz,
						CString& aNid, UINT StaLBased)
{
...
void CMI_D_R::SetInfoForBase(CDrD_R* pStaL)
{
...
void CMI_D_R::Serialize(CArchive& ar)
{
