...
////////////////////////////////////
IMPLEMENT_SERIAL(CMI_Prs,CMI_GangS,1)
/////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////// Poting Helper
CDrPrs* CMI_Prs::CreateCurveBased(CString& LoadID, CDrCurve* pCurve,
...
/*
	...
	if(nActiveIndex>=0)
	{
		pAdd = (CDrPrs*)pDListMgr->GetObject(nActiveIndex);
...
*/
	...
	{
	    pAdd = (CDrPrs*)(pObjectMgr->AddToDataBase(nActiveIndex,FORCE));
		///////////////////////////////////////////// init Raw StaL Data
		pAdd->InitRawData();
		/////////////////////
...
CDrPrs* CMI_Prs::CreateNodeBased(CString& LoadID, CDrNode* pNode,
						double Tx,double Ty,double Tz,CString& aNid, UINT StaLBased)
{
...
void CMI_Prs::SetInfoForBase(CDrPrs* pStaL)
{
...
void CMI_Prs::Serialize(CArchive& ar)
{
