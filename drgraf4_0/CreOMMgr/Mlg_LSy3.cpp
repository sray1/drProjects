...
CMlg_LSy3::CMlg_LSy3(CWnd* pParent /*=NULL*/)
	: CDialog(CMlg_LSy3::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CMlg_LSy3)
	//}}AFX_DATA_INIT
	
}


void CMlg_LSy3::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMlg_LSy3)
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CMlg_LSy3, CDialog)
	//{{AFX_MSG_MAP(CMlg_LSy3)
...
/////////////////////////////////////////////////////////////////////////////
// CMlg_LSy3 message handlers

BOOL CMlg_LSy3::OnInitDialog()
{
...
void CMlg_LSy3::FillListAllString_Pool()
{
...
void CMlg_LSy3::EmptyListAllString()
{
...
void CMlg_LSy3::GetUnitNormal(pWORLD pNormal) 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
...
void CMlg_LSy3::SetUpLocalm(pMATRIX pM)
{
	////////////////////////////////////////////////////////////
