...
////////////////////////////////////
IMPLEMENT_SERIAL(CSolCreOM,CPatCreOM,1)
/////////////////////////////////////////////////////////////////////////////
CSolCreOM::CSolCreOM()
{
...
void CSolCreOM::Terminate_SOL(BOOL bError)
{
...
void CSolCreOM:: ElementLeftDown_SOL()
{	
	ElementLeftDown_NOD();
}

void CSolCreOM::OnEBoxLButtonDown_SOL(CClientDC* pdc,CView* pView,GENERATE gener,
...
int CSolCreOM::LeftUp_GetSolid_Parent(POINT point)
{
	int nResult;
...
int CSolCreOM::LeftUp_TRANSLATE_SOL(POINT point)
{
...
int CSolCreOM::LeftUp_ROTATE_SOL(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CSolCreOM::LeftUp_SCALE_SOL(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CSolCreOM::LeftUp_REFLECT_SOL(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CSolCreOM::LeftUp_SHEAR_SOL(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
void CSolCreOM::ElementLeftUp_SOL(CPoint point)
{                          
...
int CSolCreOM::LeftUp_Solid_Accept(CPoint point)
{
	///////////////////////////////////////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr();
...
int CSolCreOM::LeftUp_SSPAWN(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
//	if(m_bDirect && m_bDominant)
...
int CSolCreOM::ShowParentSolidInfo(CDrSolid* pDrSolid)
{
	int nResult;
	CString ID;
	CString* pID = &ID;
...
int CSolCreOM::ShowSolidToSpawn(CDrSolid* pParentSolid,BOOL bUsingDlg)
{
	int nResult = 0;
	////////////////
	C3DMath			Math3D;
...
int CSolCreOM::ShowSolidToSpawnCopyOff(CDrSolid* pParentSolid,BOOL bUsingDlg)
{
	int				nResult;
	int index;
	///////////////////////
...
ERRORHANDLER:
	AfxMessageBox("Internal ERROR\nCSolCreOM::ShowSolidToSpawnCopyOff");
	/////////////////////////////////////// Reset
	m_nInfoDone		= 0;
	m_bDone			= TRUE;	// 
	//////////////////////////
...
int CSolCreOM::SolidDependent_SpawnConnectedObjects_CopyOff(CDrSolid* pCurrentSolid,BOOL bUsingDlg,
																					UINT nObjType)
{
	////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	...
	for(i=0;i<nCount;i++)
	{
		...
		if(pObject)
		{
			...
			{
				AfxMessageBox(
					"Internal ERROR\nCSolCreOM::SolidDependent_SpawnConnectedObjects_CopyOff");
				return nResult;
			}
		}
	}
...
int CSolCreOM::SolidSpawnCopyOff(CDrSolid* pParentSolid,BOOL bUsingDlg)
{
	int nResult;
	C3DMath			Math3D;
	///////////////////////
...
void CSolCreOM::OnEBoxMouseMove_SOL(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{  
...
void CSolCreOM::OnEBoxLButtonUp_SOL(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSolCreOM::OnEBoxRButtonDown_SOL(CClientDC* pdc,CView* pView,GENERATE gener,
									UINT nFlags, CPoint point)
{ 
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSolCreOM::OnEBoxRButtonUp_SOL(CClientDC* pdc,CView* pView,GENERATE gener,
								UINT nFlags, CPoint point)
{
	CString strCur;
	//////////
...
long CSolCreOM::CreateorActivateCreOp_SOL(UINT wParam, long lParam)
{
	/////////////////////////////////////////// Parent Info
	m_ParentType	= SOLID;
...
long CSolCreOM::GoodByeCreOp_SOL(UINT wParam, long lParam)
{
...
long CSolCreOM::CancelCreOp_SOL(UINT wParam, long lParam)
{
...
/////////////////////////////////////////////////////////////////////////////////////// 
UINT CSolCreOM::ReSetToolID_SOL(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CString strCur;
	////////////////
...
void CSolCreOM::Serialize(CArchive& ar)
{

	CPatCreOM::Serialize( ar);              // must call base class Serializer
	/////////////////////////
	if (ar.IsStoring())
	{
		TRACE(" SolCreOM:    Storing\n");	
		

	}
	else
	{
		TRACE(" SolCreOM:    Loading\n");	
