...
CMlg_CrOI::CMlg_CrOI(CWnd* pWnd)
	: CDialog()                    // Modeless constructor
{
	//{{AFX_DATA_INIT(CMlg_CrOI)
	m_ObjID			= _T("");
	m_X				= 0.0;
	m_Y				= 0.0;
	m_Z				= 0.0;
...
void CMlg_CrOI::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMlg_CrOI)
...
BEGIN_MESSAGE_MAP(CMlg_CrOI, CDialog)
	//{{AFX_MSG_MAP(CMlg_CrOI)
...
/////////////////////////////////////////////////////////////////////////////
// CMlg_CrOI message handlers

BOOL CMlg_CrOI::OnInitDialog()
{
...
#endif
	///////////////////////////////////////////////////////////// 
	bOk = CDialog::Create(CMlg_CrOI::IDD);
	///////////////////////////////////////
#ifdef _AFXDLL
//	CString strRes;
...
BOOL CMlg_CrOI::OnHelpInfo(HELPINFO* pHelpInfo) 
{
...
void CMlg_CrOI::OnAxisX() 
{
	m_nAxis	= 1;	
}

void CMlg_CrOI::OnAxisY() 
{
	m_nAxis	= 2;	
}

void CMlg_CrOI::OnAxisZ() 
{
	m_nAxis	= 3;	
}
/////////////////////////// end of module //////////////
