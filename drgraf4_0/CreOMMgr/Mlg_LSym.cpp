...
CMlg_LSym::CMlg_LSym(CWnd* pParent /*=NULL*/)
	: CDialog(CMlg_LSym::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CMlg_LSym)
	m_RotPtID	= _T("");
	m_FromID	= "";
	m_ToID		= "";
	//}}AFX_DATA_INIT
...
void CMlg_LSym::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMlg_LSym)
...
BEGIN_MESSAGE_MAP(CMlg_LSym, CDialog)
	//{{AFX_MSG_MAP(CMlg_LSym)
...
/////////////////////////////////////////////////////////////////////////////
// CMlg_LSym message handlers

BOOL CMlg_LSym::OnInitDialog()
{
...
void CMlg_LSym::OnSelchangeCnodeFrom() 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
...
void CMlg_LSym::OnSelchangeCnodeTo() 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
...
void CMlg_LSym::OnSelchangeRotpt() 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
...
int CMlg_LSym::FillListAllString(UINT DlgItemID,CString& IstID)
{
...
void CMlg_LSym::GetUnitNormal(pWORLD pNormal) 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
...
void CMlg_LSym::SetUpLocalm(pMATRIX pM)
{
	////////////////////////////////////////////////////////////
	...
	int index;
	/////////////////////////////////////////////
	index = pDListMgr->GetObjectIndex(FE0D,m_RotPtID);
