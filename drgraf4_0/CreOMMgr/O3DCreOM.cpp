...
////////////////////////////////////
IMPLEMENT_SERIAL(CO3DCreOM,CSolCreOM,1)
/////////////////////////////////////////////////////////////////////////////
CO3DCreOM::CO3DCreOM()
{
...
void CO3DCreOM::Terminate_O3D(BOOL bError)
{
...
void CO3DCreOM:: ElementLeftDown_O3D()
{	
	ElementLeftDown_NOD();
}

void CO3DCreOM::OnEBoxLButtonDown_O3D(CClientDC* pdc,CView* pView,GENERATE gener,
...
int CO3DCreOM::LeftUp_GetObj3D_Parent(POINT point)
{
	int nResult;
...
int CO3DCreOM::LeftUp_TRANSLATE_O3D(POINT point)
{
...
int CO3DCreOM::LeftUp_ROTATE_O3D(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CO3DCreOM::LeftUp_SCALE_O3D(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CO3DCreOM::LeftUp_REFLECT_O3D(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
int CO3DCreOM::LeftUp_SHEAR_O3D(POINT point)
{
//	if(m_bDirect && m_bDominant)
//		return -1;	// Should Not be Here
	///////////////////
...
void CO3DCreOM::ElementLeftUp_O3D(CPoint point)
{                          
...
int CO3DCreOM::LeftUp_Obj3D_Accept(CPoint point)
{
	///////////////////////////////////////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr();
...
int CO3DCreOM::LeftUp_OSPAWN(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
//	if(m_bDirect && m_bDominant)
...
int CO3DCreOM::ShowParentObj3DInfo(CDrObj3D* pDrObj3D)
{
	int nResult;
	CString ID;
	CString* pID = &ID;
...
int CO3DCreOM::ShowObj3DToSpawn(CDrObj3D* pParentObj3D,BOOL bUsingDlg)
{
	int nResult = 0;
	////////////////
	C3DMath			Math3D;
...
int CO3DCreOM::ShowObj3DToSpawnCopyOff(CDrObj3D* pParentObj3D,BOOL bUsingDlg)
{
	int	nResult;
	int index;
	///////////////////////
...
int CO3DCreOM::Obj3DDependent_SpawnConnectedObjects_CopyOff(CDrObj3D* pCurrentObj3D,BOOL bUsingDlg,
																					UINT nObjType)
{
	////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	...
	for(i=0;i<nCount;i++)
	{
		...
		if(pObject)
		{
			...
			{
				AfxMessageBox(
					"Internal ERROR\nCO3DCreOM::Obj3DDependent_SpawnConnectedObjects_CopyOff");
				return nResult;
			}
		}
	}
...
int CO3DCreOM::Obj3DSpawnCopyOff(CDrObj3D* pParentObj3D,BOOL bUsingDlg)
{
	int nResult;
	C3DMath			Math3D;
	///////////////////////
...
void CO3DCreOM::OnEBoxMouseMove_O3D(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{  
...
void CO3DCreOM::OnEBoxLButtonUp_O3D(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CO3DCreOM::OnEBoxRButtonDown_O3D(CClientDC* pdc,CView* pView,GENERATE gener,
									UINT nFlags, CPoint point)
{ 
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CO3DCreOM::OnEBoxRButtonUp_O3D(CClientDC* pdc,CView* pView,GENERATE gener,
								UINT nFlags, CPoint point)
{
	CString strCur;
	//////////
...
long CO3DCreOM::CreateorActivateCreOp_O3D(UINT wParam, long lParam)
{
	/////////////////////////////////////////// Parent Info
	m_ParentType	= OBJ3D;
...
long CO3DCreOM::GoodByeCreOp_O3D(UINT wParam, long lParam)
{
...
long CO3DCreOM::CancelCreOp_O3D(UINT wParam, long lParam)
{
...
/////////////////////////////////////////////////////////////////////////////////////// 
UINT CO3DCreOM::ReSetToolID_O3D(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CString strCur;
	////////////////
...
void CO3DCreOM::Serialize(CArchive& ar)
{

	CSolCreOM::Serialize( ar);              // must call base class Serializer
	/////////////////////////
	if (ar.IsStoring())
	{
		TRACE(" O3DCreOM:    Storing\n");	
		

	}
	else
	{
		TRACE(" O3DCreOM:    Loading\n");	
