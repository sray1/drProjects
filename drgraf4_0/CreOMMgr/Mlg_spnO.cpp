...
CMlg_SpnO::CMlg_SpnO(CWnd* pParent /*=NULL*/)
	: CDialog(CMlg_SpnO::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CMlg_SpnO)
	m_SpawnID	= _T("");
	m_CID		= _T("");
	//}}AFX_DATA_INIT
	m_pMatObj	= NULL;
...
void CMlg_SpnO::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CMlg_SpnO)
...
BEGIN_MESSAGE_MAP(CMlg_SpnO, CDialog)
	//{{AFX_MSG_MAP(CMlg_SpnO)
...
/////////////////////////////////////////////////////////////////////////////
// CMlg_SpnO message handlers

BOOL CMlg_SpnO::OnInitDialog() 
{
	...
	int nMaxObj3Ds 	 = pDListMgr->GetSpecificObjectCount(MBJ3D);
	if(nMaxObj3Ds)
	{
...
///////////////////////////////////////////////////////
void CMlg_SpnO::FillListAllString_Pool()
{
	// with Obj3DS
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	...
	for (;pos !=NULL;)
	{
		...
		if( pObject->GetObjectType() == MBJ3D)
		{ 
			CDrMbj3D* pObj3D = (CDrMbj3D*)pObject;
...
void CMlg_SpnO::FillListAllObj3DIDs()
{
...
void CMlg_SpnO::SetInfoForDataBase(CDrMbj3D* pDrObject)
{
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
    ...
    int index;  
	////////////////////////////////////
    pDrObject->SetObjectType((int)MBJ3D);
    pDrObject->SetElemType((int)GENR_OBJECT);          	// globals
    pDrObject->SetLevelType((int)LEVEL_GRAPA);          // globals
    ////////////////////////////////////////// Get Old Obj3D Info
	pDListMgr	= pObjectMgr->GetObjectList(MBJ3D);
	index = pObjectMgr->GetObjectIndexfromKey(MBJ3D,m_CID,1);
	if(index>=0)
		pDrObj3D = (CDrMbj3D*)(pDListMgr->GetObject(index));
	////////////////
