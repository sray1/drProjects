...
// CMouse view
//////////////////////////////////////////////////////
class AFX_EXT_CLASS CMI_MSPN : public CMI_3SPN
{
public:

	CMI_MSPN();
//////////////////////////////////////
	DECLARE_SERIAL(CMI_MSPN)
//////////////////////////////////////
...
public:
	...
	void	SetpDrObj3D(CDrMbj3D* p){m_pDrObj3D = p;};	// because of Obj3DList in Obj3D
	//////////
	int		SpawnObj3DShowingDlg(CDrMbj3D* pNewObj3D,CDrMbj3D* pOldObj3D,
										CDrObject* pContextObj,UINT nContextType); 
	int		SpawnObj3DWithoutDlg(CDrMbj3D* pNewObj3D,CDrMbj3D* pOldObj3D,pMATRIX pXFMat,
									CString* pCid,CDrObject* pContextObj,UINT nContextType);
 	//////////////////////////////////////////////////////////////////////////////////
	int		FillSpawnedObj3DDlgDataBase(CDrMbj3D* pDrObj3D,CString& Cid,CString& ParentCid);
   				
		
protected:

	int		GetInfoFromDlg(CDrMbj3D* pNewObj3D, CDrMbj3D* pOldObj3D);
