...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CMCNodBox, CBoxWnd)
	//{{AFX_MSG_MAP(CMCNodBox)
	ON_WM_CREATE()
	ON_WM_DESTROY()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP() 
...
IMPLEMENT_DYNAMIC(CMCNodBox,CBoxWnd)
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CMCNodBox message handlers
int CMCNodBox::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!CreateElemBar())
	{	
		AfxMessageBox("CMCNodBox::OnCreate\nCannot Create NodeBar");
		return -1;
    }
...
BOOL CMCNodBox::CreateElemBar()
{
	...
	{
		AfxMessageBox("ERROR:CMCNodBox::CreateNodeBar()\nButton Count Discrepancy");
		return FALSE;
	}
	////////////////////////////////////////////////////////////////////// 
	CString strRes;
...
/////////////////////////////////////////////////////////////////
	////////////////////////////////////////////			
	if (!m_wndElemBar.Create(this, nLeft, nTop,IDW_MCNODBOX,IDC_BUTTON) ||
		!m_wndElemBar.LoadBitmap(IDB_MCNODBOX)|
		!m_wndElemBar.SetButtons(Nodebox,sizeof(Nodebox)/sizeof(UINT),m_nElemBarColMax) )
	{
		TRACE("CMCNodBox::Failed to create Nodebar\n");
...
/*
int CMCNodBox::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
...
*/
void CMCNodBox::GoRespondtoMouse()
{
...
//	int BoxWidth,BoxHeight,index;
	...
	///////////////////////
	m_WPARAM = IDW_MCNODBOX;
//	ReSetDataDialogs();
	/////////////
	switch(GetActiveElemObject())
	{
		case MCNODE:
			str = "MESH@Control Node";
