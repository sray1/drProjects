...
#endif 
/////////////////////////////////////////////////////////////////////////////
IMPLEMENT_DYNAMIC(CNodeBar,CPaletteBar)

BEGIN_MESSAGE_MAP(CNodeBar, CPaletteBar)
	//{{AFX_MSG_MAP(CNodeBar)
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_DESTROY()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP() 
// CNodeBar construction/destruction
...
/////////////////////////////////////////////////////////////////////////////
// CNodeBar diagnostics

#ifdef _DEBUG
void CNodeBar::AssertValid() const
{
	CToolBar::AssertValid();
}

void CNodeBar::Dump(CDumpContext& dc) const
{
	CToolBar::Dump(dc);
}
...
void CNodeBar::OnLButtonDown(UINT nFlags, CPoint point)
{
	int Num;
	int iImage;
	UINT nID,nStyle;
	...
	else if((Num = HitTest(point)) >= 0)
	{
		...
		CToolBar* pTool = (CToolBar*)GetParent()->
			GetDescendantWindow(IDW_NODEBOX);
		///////////////////////////////////////////////////////// Objects	
		m_nActiveNodeObjectOld = m_nActiveNodeObject;
...
void CNodeBar::OnLButtonUp(UINT nFlags, CPoint point)
{ 
	int iImage;
	UINT nID,nStyle;
	/////////////////
	if (m_bButtonDown)
	{
		...
		pTool->GetButtonInfo(m_nActiveNodeObject,nID,nStyle,iImage);								
		//////////////////////////////////////////// set ID	
		CNodeBox* pElemBox = (CNodeBox*) GetParent();
