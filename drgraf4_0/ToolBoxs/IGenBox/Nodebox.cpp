...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CNodeBox, CBoxWnd)
	//{{AFX_MSG_MAP(CNodeBox)
	ON_WM_CREATE()
	ON_WM_DESTROY()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP() 
...
IMPLEMENT_DYNAMIC(CNodeBox,CBoxWnd)
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CNodeBox message handlers
int CNodeBox::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!CreateElemBar())
	{	
		AfxMessageBox("CNodeBox::OnCreate\nCannot Create NodeBar");
		return -1;
    }
...
BOOL CNodeBox::CreateElemBar()
{
	...
	{
		AfxMessageBox("ERROR:CNodeBox::CreateNodeBar()\nButton Count Discrepancy");
		return FALSE;
	}
	////////////////////////////////////////////////////////////////////// 
	CString strRes;
...
/////////////////////////////////////////////////////////////////
	////////////////////////////////////////////			
	if (!m_wndElemBar.Create(this, nLeft, nTop,IDW_NODEBOX,IDC_BUTTON) ||
		!m_wndElemBar.LoadBitmap(IDB_NBOX)|
...
/*
int CNodeBox::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
...
*/
void CNodeBox::GoRespondtoMouse()
{
