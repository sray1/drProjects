// Elem.h : interface of the CSpeLBar class
//
#ifndef _SPELBAR_H
#define _SPELBAR_H                               
...
#include "palette.h"
////////////////////////////
//class AFX_EXT_CLASS CSpeLBar : public CPaletteBarN
class CSpeLBar : public CPaletteBar
{
// Constructor
public:
...
protected:
	...
	int		m_nActiveSpeLObject;    // other objects 
	int		m_nActiveSpeLObjectOld;
	int		m_nCheck[200];
