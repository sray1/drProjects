// Tribox.cpp : implementation file
//
#include "stdafx.h"
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CTriBox, CEoxWnd)
	//{{AFX_MSG_MAP(CTriBox)
	ON_WM_CREATE()
	ON_WM_PAINT()  
	ON_WM_DESTROY()
...
IMPLEMENT_DYNAMIC(CTriBox,CEoxWnd)
/////////////////////////////////////////////////////////////////////////////
//array ofIDs Used to Initialize Elembar

static UINT BASED_CODE Tribox[] =
{
	// same order as in the bitmap 'Tribox.bmp'
	IDB_TR_3,//						1107		// Triangle 3 Nodes
	IDB_TR_6,//						1108		// Triangle 6 Nodes
	IDB_TR_9,//						1109		// Triangle 9 Nodes
	IDB_TR_10//						1110		// Triangle 10 Nodes
...
/////////////////////////////////////////////////////////////////////////////
// CTriBox message handlers
int CTriBox::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	if (CEoxWnd::OnCreate(lpCreateStruct) == -1)
		return -1; 
	...
	if (!CreateElemBar())
	{	
		AfxMessageBox("CTriBox::OnCreate\nCannot Create ElemBar");
		return -1;
    }
...
BOOL CTriBox::CreateElemBar()
{
	...
	nTop  = Rect.top;
	////////////////////////////////////////////////////////////////////
	m_nElemBarButtCount = sizeof(Tribox)/sizeof(UINT); //EB_BUTT_COUNT 
	if(m_nElemBarButtCount != EB_BUTT_COUNT)
	{
		AfxMessageBox("ERROR:CTriBox::CreateElemBar()\nButton Count Discrepancy");
		return FALSE;
	}
	////////////////////////////////////////////////////////////////////// 
	CString strRes;
...
*/
	...
	AfxSetResourceHandle(extensionEBox_DLL.hModule); // uses client's instance handle 
	strRes.LoadString(IDS_CHECK_RESOURCE);
	TRACE("TRITA resource string = %s\n", (const char*) strRes); 
#endif
/////////////////////////////////////////////////////////////////
	////////////////////////////////////////////			
	if (!m_wndElemBar.Create(this, nLeft, nTop,IDW_TRIBOX,IDC_BUTTON) ||
		!m_wndElemBar.LoadBitmap(IDB_TRIBOX) ||
		!m_wndElemBar.SetButtons(Tribox,sizeof(Tribox)/sizeof(UINT),m_nElemBarColMax) )
	{
...
/*
int CTriBox::OnMouseActivate(CEoxWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
