...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CMeshBox2, CEoxWnd)
	//{{AFX_MSG_MAP(CMeshBox2)
	ON_WM_CREATE()
	ON_WM_PAINT()  
	ON_WM_MOUSEACTIVATE()
	ON_WM_DESTROY()
...
IMPLEMENT_DYNAMIC(CMeshBox2,CEoxWnd)
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// CMeshBox2 message handlers
int CMeshBox2::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!CreateElemBar())
	{	
		AfxMessageBox("CMeshBox2::OnCreate\nCannot Create ElemBar");
		return -1;
    }
...
BOOL CMeshBox2::CreateElemBar()
{
	...
	{
		AfxMessageBox("ERROR:CMeshBox2::CreateElemBar()\nButton Count Discrepancy");
		return FALSE;
	}
	////////////////////////////////////////////////////////////////////// 
	CString strRes;
...
/////////////////////////////////////////////////////////////////
	////////////////////////////////////////////			
	if (!m_wndElemBar.Create(this, nLeft, nTop,IDW_MESHBOX2,IDC_BUTTON) ||
		!m_wndElemBar.LoadBitmap(IDB_MESHBOX2) ||
		!m_wndElemBar.SetButtons(elembox,sizeof(elembox)/sizeof(UINT),m_nElemBarColMax) )
	{
		TRACE("CMeshBox2::CreateElemBar\nFailed to create toolbar\n");
...
int CMeshBox2::OnMouseActivate(CWnd* pDesktopWnd, UINT nHitTest, UINT message)
{
...
void CMeshBox2::GoRespondtoMouse()
{
