...
/////////////////////////////////////////////////////////////////////////////
////////////////////////////////////
IMPLEMENT_SERIAL(CMC_Cube,CMI_GangC,1)
/////////////////////////////////////////////////////////////////////////////
CMC_Cube::CMC_Cube()
{
    /////////////////////////////////////////// Curve
...
int CMC_Cube::GoDoIt(CDrCurve* pCurve,BOOL bFinal)  
{
	m_CurveType_S	= CP_NURB;
	m_nOrder_S		= 4;
	///////////////////////////////
...
CDrCurve* CMC_Cube::GetInfo(int nButton)
{
...
int CMC_Cube::InterPolate_C3(BOOL bFinal)
{
	...
	if(C3_PostInterpolation(&Inter_C3,bFinal)<0)
		return -1;
	///////////////////////
	return 0; 
}

int CMC_Cube::C3_SetMemory()
{
...
int CMC_Cube::C3_PrepInterpolation(CInter_C3* pInter_C3)
{
	////////////
	...
	if(1 != 1) // iDLL = 12 , Module = 1
	{
		...
		int j;
		//////////
		sprintf(buf,"CMC_Cube::C3_PrepInterpolation");
		AfxMessageBox(*str);
		///////////////////
...
//	pInter_C3->SetnSeg_BS_S(nSeg_BS);
	...
	pInter_C3->SetnCon_BZ_S(m_pDrCurve->GetnCon_BZ_S()); // = m_nMaxCurveCNodes_S_S
	////////////////////////////////////////////// Send Memory
...
int CMC_Cube::C3_PostInterpolation(CInter_C3* pInter_C3,BOOL bFinal)
{
...
//			}
	...
	{				
// 		already assigned
//		m_pWts_BZ_S = new double[m_nMaxCurveCNodes_S_S]; // needed later for TensorProduct Patch
		for(s=0;s<m_nMaxCurveCNodes_S;s++)
			m_pWts_BZ_S[s] = 1.0;
		//////////////////////////////////////		
...
void CMC_Cube::Serialize(CArchive& ar)
{
