// Dlg_CR5I.cpp : implementation file similar to Old: Dlg_Circ.cpp
// CIRCLE_BY_2CN_TI_R
...
CDlg_Cr5I::CDlg_Cr5I(CWnd* pWnd)
	: CDialog()                    // Modeless constructor
{
	//{{AFX_DATA_INIT(CDlg_Cr5I)
	m_CurveID 	= "";
...
void CDlg_Cr5I::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_Cr5I)
	...
	DDV_MinMaxDouble(pDX, m_dRadius, 1.e-002, 9999.);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_Cr5I, CDialog)
	//{{AFX_MSG_MAP(CDlg_Cr5I)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_Cr5I message handlers

BOOL CDlg_Cr5I::OnInitDialog()
{
...
#endif
	/////////////////////////////////////////////////////////////
	bOk = CDialog::Create(CDlg_Cr5I::IDD);
	///////////////////////////////////////
#ifdef _AFXDLL
//	CString strRes;
...
void CDlg_Cr5I::OnKillfocusSegAngle()
{
    ////////////////////
	UpdateData(TRUE);		    //FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_Cr5I::FillListAllCurveIDs()
{
...
void CDlg_Cr5I::FillListAllNodeIDs()
{
...
void CDlg_Cr5I::OnSelchangeCid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr5I::OnSelchangeNid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr5I::OnUpdate() 
{
	if(m_pWnd !=NULL)
		m_pWnd->SendMessage(ID_UPDATE_CR2IN,IDC_UPDATE);
}
/*
void CDlg_Cr5I::OnCancel() 
{
	CDialog::OnCancel();
	////////////////////
	if(m_pWnd !=NULL)
