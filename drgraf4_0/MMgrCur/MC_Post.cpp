...
#define wEQL(a,b)	((a).x ==(b).x) && ((a).y ==(b).y) \
					&& ((a).z ==(b).z)  
////////////////////////////////////
IMPLEMENT_SERIAL(CMC_Post,CMI_Curve,1)
/////////////////////////////////////////////////////////////////////////////
CMC_Post::CMC_Post()
{
	m_pOut = NULL;
...
void CMC_Post::CalcCentroid(pWORLD pC,UINT ix0,UINT ix1,UINT ix2,UINT ix3)
{
	CDrNode* pNode;
	/////////////////////////
...
int CMC_Post::SubDivide_FWD(CString& PolyID,UINT ix0,UINT ix1,UINT ix2,UINT ix3)
{ 
	C3DMath Math3D;
	///////////////
	CDrNode* pNode;
...
void CMC_Post::ValidateSubDiv(void)
{
	switch( m_nSubDiv ) 
	{
		case SU_NOSUB:
...
CDrNode* CMC_Post::PostNode(CString& Nid,WORLD Pt,BOOL bCNode)
{
...
CDrPlat* CMC_Post::MakePoly_3(CString& PolyID,int ix0,int ix1,int ix2)
{
    CNewObjs*	pNewObjs;
    /////////////////////
	int ix[3];
...
CDrPlat* CMC_Post::MakePoly_4(CString& PolyID,int ix0,int ix1,int ix2,int ix3)
{
	CNewObjs*	pNewObjs;
	/////////////////////
	int ix[4];
...
CDrNode* CMC_Post::PostPoly(CDrPlat* pPoly,int* index,int nEnds)
{
...
CDrPatch* CMC_Post::Post_GetInfo()
{
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
	CDListMgr* pDListMgr;
...
////////////////////////////////////////////////////////////
void CMC_Post::Serialize(CArchive& ar)
{
