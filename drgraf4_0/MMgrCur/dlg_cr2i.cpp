// Dlg_CR2I.cpp : implementation file similar to Old: Dlg_Circ.cpp
// Circle by Rotation
#include "stdafx.h"
...
CDlg_Cr2I::CDlg_Cr2I(CWnd* pWnd)
	: CDialog()                    // Modeless constructor
{
	//{{AFX_DATA_INIT(CDlg_Cr2I)
	m_dAng		= 0.0;
	m_FromID	= _T("");
	m_ToID		= _T("");
	m_NodeID	= _T("");
...
void CDlg_Cr2I::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_Cr2I)
	...
	DDV_MinMaxDouble(pDX, m_dAng, 1., 360.);
...
BEGIN_MESSAGE_MAP(CDlg_Cr2I, CDialog)
	//{{AFX_MSG_MAP(CDlg_Cr2I)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_Cr2I message handlers

BOOL CDlg_Cr2I::OnInitDialog()
{
...
#endif
	/////////////////////////////////////////////////////////////
	bOk = CDialog::Create(CDlg_Cr2I::IDD);
	///////////////////////////////////////
#ifdef _AFXDLL
//	CString strRes;
...
void CDlg_Cr2I::OnKillfocusSegAngle()
{
    ////////////////////
	UpdateData(TRUE);		    //FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_Cr2I::FillListAllCurveIDs()
{
...
void CDlg_Cr2I::FillListAllNodeIDs()
{
...
void CDlg_Cr2I::OnSelchangeCid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr2I::OnSelchangeNid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr2I::OnUpdate() 
{
	if(m_pWnd !=NULL)
		m_pWnd->SendMessage(ID_UPDATE_CR2IN,IDC_UPDATE);
}
/*
void CDlg_Cr2I::OnCancel() 
{
	CDialog::OnCancel();
	////////////////////
	if(m_pWnd !=NULL)
