// Dlg_CR4I.cpp : implementation file similar to Old: Dlg_Circ.cpp
// CIRCLE_BY_2N_CC_R
...
CDlg_Cr4I::CDlg_Cr4I(CWnd* pWnd)
	: CDialog()                    // Modeless constructor
{
	//{{AFX_DATA_INIT(CDlg_Cr4I)
	m_CurveID 	= "";
...
void CDlg_Cr4I::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_Cr4I)
...
BEGIN_MESSAGE_MAP(CDlg_Cr4I, CDialog)
	//{{AFX_MSG_MAP(CDlg_Cr4I)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_Cr4I message handlers

BOOL CDlg_Cr4I::OnInitDialog()
{
...
#endif
	/////////////////////////////////////////////////////////////
	bOk = CDialog::Create(CDlg_Cr4I::IDD);
	///////////////////////////////////////
#ifdef _AFXDLL
//	CString strRes;
...
void CDlg_Cr4I::OnKillfocusSegAngle()
{
    ////////////////////
	UpdateData(TRUE);		    //FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_Cr4I::FillListAllCurveIDs()
{
...
void CDlg_Cr4I::FillListAllNodeIDs()
{
...
void CDlg_Cr4I::OnSelchangeCid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr4I::OnSelchangeNid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_Cr4I::OnUpdate() 
{
	if(m_pWnd !=NULL)
		m_pWnd->SendMessage(ID_UPDATE_CR2IN,IDC_UPDATE);
}
/*
void CDlg_Cr4I::OnCancel() 
{
	CDialog::OnCancel();
	////////////////////
	if(m_pWnd !=NULL)
