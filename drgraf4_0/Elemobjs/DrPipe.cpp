...
/////////////////////////////////////////////////////////////////////////////
// CDrPipe
IMPLEMENT_SERIAL(CDrPipe, CDrFE1D,1)
/*
BEGIN_MESSAGE_MAP(CDrPipe, CDrFE1D)
	//{{AFX_MSG_MAP(CDrPipe)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrPipe::GetObjectInfo(CDrObject* pObject)
{
	...
	pAdd->m_bValve			= m_bValve;  
	////////////////////
	return;
}		

void CDrPipe::DoFormattedCardView(CString* pstrCard,CString& strFmt)
{
	m_bFormatted = TRUE;	// DrObject Element
//	Pack_drPipe(pstrCard);
} 

void CDrPipe::DoUnFormattedCardView(CString* pstrCard)
{
...
//////////////////////////////////////////////////////////////////
BOOL CDrPipe::IsKeyMatch(CString KeyID,UINT KeyNo)
{
	return FALSE;
}
...
BOOL CDrPipe::IsObjectHit(int nNet, POINT point)
{
