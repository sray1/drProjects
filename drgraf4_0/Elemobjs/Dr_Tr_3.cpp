...
/////////////////////////////////////////////////////////////////////////////
// CDr_Tr_3
IMPLEMENT_SERIAL(CDr_Tr_3, CDrFE2D,1)
/*
BEGIN_MESSAGE_MAP(CDr_Tr_3, CDrFE2D)
	//{{AFX_MSG_MAP(CDr_Tr_3)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
/////////////////////////////////////////////////////////////////////////////
...
void CDr_Tr_3::DoFormattedCardView(CString* pstrCard,CString& strFmt)
{
	m_bFormatted = TRUE;	// DrObject Element
//	Pack_drPipe(pstrCard);
} 

void CDr_Tr_3::DoUnFormattedCardView(CString* pstrCard)
{
...
void CDr_Tr_3::DoDataView(CDC* PtrDC, int y)
{
...
void CDr_Tr_3::Pack_drPipe(CString* pstrCard)
{
	static CString name;
	POSITION	pos;
	int			i; 
...
void CDr_Tr_3::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDr_Tr_3::GoDoIt(CDC* PtrDC,BOOL bPenChange)
{ 
	CDListMgr* 	pList;
	POSITION 	pos;
    ////////////////
...
/////////////////////////////////////////////////////////////////////////////
BOOL CDr_Tr_3::IsKeyMatch(CString KeyID,UINT KeyNo)
{
	return FALSE;
}
	
BOOL CDr_Tr_3::IsObjectHit(int nNet,POINT point)
{
...
void CDr_Tr_3::Serialize(CArchive& ar)
{
	...
	if (ar.IsStoring())
	{
		TRACE( " CDr_Tr_3   :Storing\n");	// TODO: add loading code here

 	}
	else
	{
	
		TRACE( " CDr_Tr_3   :Loading\n");	// TODO: add loading code here
