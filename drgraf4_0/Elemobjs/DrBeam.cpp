...
/////////////////////////////////////////////////////////////////////////////
// CDrBeam
IMPLEMENT_SERIAL(CDrBeam, CDrFE1D,1)
/*
BEGIN_MESSAGE_MAP(CDrBeam, CDrFE1D)
	//{{AFX_MSG_MAP(CDrBeam)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrBeam::SetObjectInfo(CDrObject* pObject)
{
	
	CDrFE1D::SetObjectInfo(pObject);	
	////////////////////////////////////////////////////////   
	CDrBeam* pAdd = (CDrBeam*) pObject;
	///////////////////////////////////////////////////// BEAMINFO
	////////////////////
	return;
}		

void CDrBeam::GetObjectInfo(CDrObject* pObject)
{
...
void CDrBeam::DoFormattedCardView(CString* pstrCard,CString& strFmt)
{
	m_bFormatted = TRUE;	// DrObject Element
//	Pack_drPipe(pstrCard);
} 

void CDrBeam::DoUnFormattedCardView(CString* pstrCard)
{
...
void CDrBeam::DoDataView(CDC* PtrDC, int y)
{
...
void CDrBeam::Pack_drPipe(CString* pstrCard)
{
	static CString name;
	POSITION	pos;
	int			i; 
...
//////////////////////////////////////////////////////////
void CDrBeam::TransformObjectToWorld(pMATRIX pLM,BOOL bYes)
{
	////////////////////////
...
void CDrBeam::TransformObjectToView(pMATRIX pViewM)
{
...
BOOL CDrBeam::RemoveHiddenObject(pMATRIX pViewM,WORLD VDir,int nType)
{
		return FALSE;	// do nothing
}			 
				
void CDrBeam::ProjectObject
...
void CDrBeam::TransformToWorldPos(pMATRIX pLM,BOOL bYes)
{
...
void CDrBeam::TransformToEyePos(pMATRIX pViewM)
{
...
void CDrBeam::ProjectToScreenPos
				(pMATRIX pvv3DM,double dScale_U,double dScale_V)
{
...
void CDrBeam::Calc_ScreenRectFromCNodes()
{
	/////////////////////
	FinishObject();
	///////////////
...
//////////////////////////////////////////////////////////////
void CDrBeam::InitDraw(CDC* PtrDC,BOOL bParallel,int nView,
...
//////////////////////////////////////////////////////////////
void CDrBeam::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDrBeam::GoDoIt(CDC* PtrDC,BOOL bPenChange)
{ 
...
//////////////////////////////////////////////////////////////////
BOOL CDrBeam::IsKeyMatch(CString KeyID,UINT KeyNo)
{
	return FALSE;
}

void CDrBeam::Serialize(CArchive& ar)
{
...
BOOL CDrBeam::IsObjectHit(int nNet, POINT point)
{
