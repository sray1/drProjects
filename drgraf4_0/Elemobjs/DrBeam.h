...
/////////////////////////////////////////////////////////////////////////////
// CDrBeam    ///////////////////////////////////////////////////////////////
class AFX_EXT_CLASS CDrBeam: public CDrFE1D
{
public:
// Construction                 
	CDrBeam();
	DECLARE_SERIAL(CDrBeam);
...
public:
	...
	////////////////////////////////////////////////////////////////////////////
	virtual CString&	GetKNodeID(){return m_KNodeID;};
	virtual void		SetKNodeID(CString& k){m_KNodeID = k;};
