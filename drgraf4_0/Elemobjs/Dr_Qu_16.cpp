...
/////////////////////////////////////////////////////////////////////////////
// CDr_Qu_16
IMPLEMENT_SERIAL(CDr_Qu_16, CDrFE2D,1)
/*
BEGIN_MESSAGE_MAP(CDr_Qu_16, CDrFE2D)
	//{{AFX_MSG_MAP(CDr_Qu_16)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
/////////////////////////////////////////////////////////////////////////////
...
void CDr_Qu_16::DoFormattedCardView(CString* pstrCard,CString& strFmt)
{
	m_bFormatted = TRUE;	// DrObject Element
//	Pack_drPipe(pstrCard);
} 

void CDr_Qu_16::DoUnFormattedCardView(CString* pstrCard)
{
...
void CDr_Qu_16::DoDataView(CDC* PtrDC, int y)
{
...
void CDr_Qu_16::Pack_drPipe(CString* pstrCard)
{
	static CString name;
	POSITION	pos;
	int			i; 
...
void CDr_Qu_16::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDr_Qu_16::GoDoIt(CDC* PtrDC,BOOL bPenChange)
{ 
	CDListMgr* 	pList;
	POSITION 	pos;
    ////////////////
...
/////////////////////////////////////////////////////////////////////////////
BOOL CDr_Qu_16::IsKeyMatch(CString KeyID,UINT KeyNo)
{
	return FALSE;
}
	
BOOL CDr_Qu_16::IsObjectHit(int nNet,POINT point)
{
...
void CDr_Qu_16::Serialize(CArchive& ar)
{
	...
	if (ar.IsStoring())
	{
		TRACE( " CDr_Qu_16   :Storing\n");	// TODO: add loading code here

 	}
	else
	{
	
		TRACE( " CDr_Qu_16   :Loading\n");	// TODO: add loading code here
