...
MOTYPES	MoTypes[] =
	{ 
		...
		"SPAWN Node",		N_COP_SPAWN,	MO_TOOL, 
		"ROTATE Node",		N_COP_ROTATE,	MO_TOOL, 
		"TRANSLATE Node",	N_COP_XLATE,	MO_TOOL, 
		"SCALE Node",		N_COP_SCALE,	MO_TOOL,
		"REFLECT Node",		N_COP_REFLECT,	MO_TOOL, 
		///////////////////////////////////////////////////////
		...
		"STITCH Curves",	C_COP_STITCH,	MO_TOOL, 
		"SPAWN Curve",		C_COP_SPAWN,	MO_TOOL, 
		"ROTATE Curve",		C_COP_ROTATE,	MO_TOOL, 
		"TRANSLATE Curve",	C_COP_XLATE,	MO_TOOL, 
		"SCALE Curve",		C_COP_SCALE,	MO_TOOL,
		"REFLECT Patch",	C_COP_REFLECT,	MO_TOOL, 
		"Curve PROFILE",	C_PROFILE,	MO_TOOL,
		///////////////////////////////////////////////////////
		"PATCH",			PATCH,		MO_OBJ_2D,
		"TENSOR Patch",		P_TENSOR,	MO_OBJ_2D,
		"GORDONS Patch",	P_GORDON,	MO_OBJ_2D,
		...
		"STITCH Patches",	P_COP_STITCH,	MO_TOOL, 
		"SPAWN Patch",		P_COP_SPAWN,	MO_TOOL, 
		"ROTATE Patch",		P_COP_ROTATE,	MO_TOOL,
		"TRANSLATE Patch",	P_COP_XLATE,	MO_TOOL, 
		"SCALE Patch",		P_COP_SCALE,	MO_TOOL, 
		"REFLECT Patch",	P_COP_REFLECT,	MO_TOOL, 
		"SHEAR Patch",		P_COP_SHEAR,	MO_TOOL, 
		"Patch PROFILE",	C_PROFILE,	MO_TOOL, 
		/////////////////////////////////////////////////////// solids
		"SOLID",			SOLID,		MO_OBJ_3D,
		"TENSOR Solid",		S_TENSOR,	MO_OBJ_3D,
		"GORDONS Solid",	S_GORDON,	MO_OBJ_3D,
		...
		"STITCH Solids",	S_COP_STITCH,	MO_TOOL, 
		"SPAWN Solid",		S_COP_SPAWN,	MO_TOOL,
		"ROTATE Solid",		S_COP_ROTATE,	MO_TOOL,
		"TRANSLATE Solid",	S_COP_XLATE,	MO_TOOL, 
		"SCALE Solid",		S_COP_SCALE,	MO_TOOL,
		"REFLECT Solid",	S_COP_REFLECT,	MO_TOOL, 
		"SHEAR Solid",		S_COP_SHEAR,	MO_TOOL 
    	///////////////////////////////////////////////////////
};
