...
//
/////////////////////////////////////////////////////////////////
//	N E E D S  W O R K	September 23,1998
//	ALL THE CN BUTTONS NEED TO BE HANDLED CAREFULLY
/////////////////////////////////////////////////////////////////
#include "stdafx.h"
...
void CDlg_Node::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_FROM_IS_CN, m_bFromCN);
	DDX_Check(pDX, IDC_POOL_IS_CN, m_bPoolCN);
	DDX_Check(pDX, IDC_REF_IS_CN, m_bRefCN);
	DDX_Check(pDX, IDC_TO_IS_CN, m_bToCN);
	//}}AFX_DATA_MAP
}
...
//		CScaleFactor* pScaleFactor 	= (CScaleFactor*)pObjectMgr->GetSpecObject(SCALEFACTOR);
	...
	GetDlgItem(IDC_POOL_IS_CN)->EnableWindow(FALSE);
...
//       case IDD_ADD:
	...
	((CListBox*)pWndCtrl)->SetCurSel(index);
	((CButton*)GetDlgItem(IDC_POOL_IS_CN))->SetCheck(m_bnid_c);
	////////////////////////////// Update all Node Combos
	FillListforAllNodeCombos();
	////////////////////////////// Update Name
	if(m_bnid_c)
		pObjectMgr->SetNodeInfoID(m_id,m_bnid_c,CNODE);
	else
		pObjectMgr->SetNodeInfoID(m_id,m_bnid_c,NODE);
	/////////////////////////////////////////
...
//       case IDD_DEL:
	...
	//////////////////
	int nMaxNodes;
	pDListMgr 	= pObjectMgr->GetNodeList_OtherContext(m_bnid_c,FALSE);
	///
