...
CDlg_ENod::CDlg_ENod(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_ENod::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_ENod)
	m_xWorld	= 0.0;
	m_yWorld	= 0.0;
	m_zWorld	= 0.0;
	m_bnid_c 	= FALSE;
...
void CDlg_ENod::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_ENod)
...
BEGIN_MESSAGE_MAP(CDlg_ENod, CDialog)
	//{{AFX_MSG_MAP(CDlg_ENod)
	ON_WM_HELPINFO()
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_ENod message handlers

BOOL CDlg_ENod::OnInitDialog()
{
...
//      case IDD_OK:     
	...
	if(m_id != OldID)
	{
		...
		int nIndex = pObjectMgr->GetObjectIndexfromKey(NODE,m_id,1);//notactive = -1
		////////////////
		if(nIndex>=0)
		{
...
////////////////////////////////////////////////////////////// HELPERS
void CDlg_ENod::FillOthers(int i)
{
...
void CDlg_ENod::SetInfoForDataBase(CDrNode* pNode,BOOL bGen)
{
...
void CDlg_ENod::SetInfoForNodeLabel(CDrNode* pAddNode,CDrLabel* pLabel)
{
...
BOOL CDlg_ENod::OnHelpInfo(HELPINFO* pHelpInfo) 
{
...
/*
void CDlg_ENod::SetCornerInfo(POINT* pCorner,POINT3* pCorner3,int nView)
{
