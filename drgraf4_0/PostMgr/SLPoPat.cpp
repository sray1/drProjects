...
////////////////////////////////////
IMPLEMENT_SERIAL(CSLDePat,CSLDeCur,1)
/////////////////////////////////////////////////////////////////////////////
CSLDePat::CSLDePat()
{
}
...
void CSLDePat::GetObjectInfo(CSLEObj* pObject)
{
	
	CSLECur::GetObjectInfo(pObject);
	///////////////////////////////////   
	CSLDePat* pAdd = (CSLDePat*) pObject;
	////////////////////////////////////////////////////////////////////// Patch
...
void CSLDePat::SetObjectInfo(CSLEObj* pObject)
{
...
int CSLDePat::ShowPatchStaticLoad(CDrPatch* pCurrentPatch,CString* pID,int nHowMany)
{
	///////////////////////////////////////////////////////////////////////
...
void CSLDePat::RemoveMostListsFromPatch(CDrPatch* pAdd)
{
...
int CSLDePat::ShowInfo_PatchStaticLoad(CDrPatch* pDrPatch, char* buf, int jStart
																	,CString& CurrentStLID)
{
	...
	for(i=0;i<pList->GetCount();i++)
	{
		...
		{
			AfxMessageBox("Internal ERROR:\nCSLDePat::FillInfo_PatchStaticLoad\npDrStatic=NULL"); 
			return -2;
		}
		/////////////////////////////////////////
...
int CSLDePat::Get_Values_Iso_Pat_Curve(CDrCurve* pCurveIsoTo,int indexCT,int indexCR,int IndexSkipNode,
...
int CSLDePat::Get_Values_NonIso_Pat(STALPROC StaLProc)
{
	AfxMessageBox("Get_Values_NonIso_Pat\nNOT IMPLEMENTED YET");
	return -1;
}
			
int CSLDePat::Get_Values_Iso_Pat(CDrPatch* pPatch,STALPROC StaLProc,CString& CurrentStPID)
{                          
...
int CSLDePat::Get_Values_IsoNod_AnyProc(CString& NodeID,
...
{									
	...
	if(index<0)
	{
		...
		int j;
		//////////
		j = sprintf(buf,"CSLDePat::Get_Values_IsoNod_AnyProc\n%s\n%s NodeIndex<0!",strProc,NodeID);
		AfxMessageBox(*str);
    	///////////////////
    	delete str;
		return -1;
...
int CSLDePat::Get_Values_IsoCur_AnyProc(CString& CurveID,int iT,int iR,int IndexSkipNode,
...
{									
	...
	if(index<0)
	{
		...
		int j;
		//////////
		j = sprintf(buf,"CSLDePat::Get_Values_IsoCur_AnyProc\n%s\n%s CurveIndex<0!",strProc,CurveID);
		AfxMessageBox(*str);
    	///////////////////
    	delete str;
		return -1;
...
int CSLDePat::Get_Values_Iso_EXTRUDE_Type1(CDrPatch* pPatchIsoTo, STALPROC StaLProc
...
int CSLDePat::Get_Values_Iso_EXTRUDE_Type2(CDrPatch* pPatchIsoTo, STALPROC StaLProc,
																CString& CurrentStPID)
{
...
int CSLDePat::Get_Values_Iso_ROTATE(CDrPatch* pPatchIsoTo, STALPROC StaLProc
																,CString& CurrentStPID)
{
	///////////////////////////////
...
int CSLDePat::Get_Values_Iso_LOFT2(CDrPatch* pPatchIsoTo, STALPROC StaLProc
																,CString& CurrentStPID)
{
...
int CSLDePat::Get_Values_Iso_COONS(CDrPatch* pPatchIsoTo, STALPROC StaLProc
																,CString& CurrentStPID)
{
...
int CSLDePat::Get_Values_Iso_DUCT(CDrPatch* pPatchIsoTo, STALPROC StaLProc
																,CString& CurrentStPID)
{
	//////////////////////////////////////////////////
...
int CSLDePat::Get_Values_Iso_SWEEP(CDrPatch* pPatchIsoTo, STALPROC StaLProc
																,CString& CurrentStPID)
{
	//////////////////////////////////////////////////
	//		case 0: "Cross Sectional Curve";
...
int CSLDePat::Generate_IsoPatchControls(CDrPatch* pPatchIsoTo,CString* pID,BOOL bTran)
{                          
...
int CSLDePat::SetUp_IsoPatchControls(CDrPatch* pPatchIsoTo,int indexP,CString* pID,BOOL bTran)
{
...
int CSLDePat::Generate_IsoControls_EXTRUDE(CDrPatch* pCurrentSPatch,CString* pID)
{
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr(); 
	//////////////////////////////////////////////////////////////// Set up
...
int CSLDePat::Generate_IsoControls_ROTATE(CDrPatch* pCurrentSPatch,CString* pID)
{
	AfxMessageBox("CSLDePat::Generate_IsoControls_ROTATE\nNOT IMPLEMENTED YET");
	return -1;
}

int CSLDePat::Generate_IsoControls_LOFT2(CDrPatch* pCurrentSPatch,CString* pID)
{
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr(); 
	//////////////////////////////////////////////////////////////// Set up
...
int CSLDePat::Generate_IsoControls_DUCT(CDrPatch* pCurrentSPatch,CString* pID)
{
	//////////////////////////////////////////////////////////////////////////////
	// Currently(03/05/97):
...
int CSLDePat::Generate_IsoControls_SWEEP(CDrPatch* pCurrentSPatch,CString* pID)
{
	//////////////////////////////////////////////////////////////////////////////
	// Currently(03/05/97):
	//		WE DONOT ALLOW DIFFERENT TWISTMULT, TWISTSTART, SCALEMULT, SCALESTART
...
int CSLDePat::Generate_IsoControls_COONS(CDrPatch* pCurrentSPatch,CString* pID)
{
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument(); 
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr();
	int i;
...
void CSLDePat::Serialize(CArchive& ar)
{

	CSLDeCur::Serialize( ar);              // must call base class Serializer
	////////////////////////////
	if (ar.IsStoring())
	{
		TRACE(" SLDePat:    Storing\n");	
