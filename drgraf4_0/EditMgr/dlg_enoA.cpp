...
CDlg_ENoA::CDlg_ENoA(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_ENoA::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_ENoA)
	m_nid_r 	= "";
	m_FromID	= "";
	m_ToID		= "";
	m_xWorld	= 0.0;
...
void CDlg_ENoA::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_ENoA)
...
BEGIN_MESSAGE_MAP(CDlg_ENoA, CDialog)
	//{{AFX_MSG_MAP(CDlg_ENoA)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_ENoA message handlers

BOOL CDlg_ENoA::OnInitDialog()
{
...
void CDlg_ENoA::Init_NodeData()
{
	...
	///////////////////////////////////////////////////////////////////////////////////////
	int nActiveObjIndex = pObjectMgr->GetObjectIndexfromKey(NODE,m_id,1);//notactive = -1
	////////////////
...
void CDlg_ENoA::OnSelchangeCnodeFrom() 
{
    ////////////////////
	UpdateData(TRUE);			//Get From Screen(TRUE)    
    ///////////////////	
...
void CDlg_ENoA::OnSelchangeCnodeTo() 
{
    ////////////////////
	UpdateData(TRUE);			//Get From Screen(TRUE)    
    ///////////////////
...
void CDlg_ENoA::OnSelchangeNodeNidR() 
{
    ////////////////////
	UpdateData(TRUE);			//Get From Screen(TRUE)    
    ///////////////////
...
int CDlg_ENoA::ResolveReference_Direction()
{
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
int CDlg_ENoA::ResolveReference_Coords()
{
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
int CDlg_ENoA::UnitAxisFromEndNodes(pWORLD pNormal)
{
	///////////////
	C3DMath	Math3D;
	//////////////////////////////////////////////////////////////
	...
	else
	{
		...
		{
			AfxMessageBox("Error:\nCDlg_ENoA::UnitAxisFromEndNodes\nFromID");
			return -1;
		}
	}
   	///////////////////////////////////////// get Raw Pt.
...
void CDlg_ENoA::OnSelchangeList()
{
//      case IDD_LIST:
	/////////////////////////////////////// do nothing Op
	if(1==1)
...
////////////////////////////////////////////////////////////// HELPERS
void CDlg_ENoA::FillOthers(int i)
{
...
void CDlg_ENoA::FillListAllString()
{
...
void CDlg_ENoA::FillListforAllNodeCombos()
{
...
void CDlg_ENoA::EmptyListAllString()
{
...
void CDlg_ENoA::SetInfoForDataBase(CDrNode* pNode,BOOL bGen)
{
...
void CDlg_ENoA::SetInfoForNodeLabel(CDrNode* pAddNode,CDrLabel* pLabel)
{
...
BOOL CDlg_ENoA::OnHelpInfo(HELPINFO* pHelpInfo) 
{
...
/*
void CDlg_ENoA::SetCornerInfo(POINT* pCorner,POINT3* pCorner3,int nView)
{
