...
////////////////////////////////////
IMPLEMENT_SERIAL(CSLECur,CSLENod,1)
/////////////////////////////////////////////////////////////////////////////
CSLECur::CSLECur()
{
...
void CSLECur::GetObjectInfo(CSLEObj* pObject)
{
	
	CSLENod::GetObjectInfo(pObject);
	///////////////////////////////////   
	CSLECur* pAdd = (CSLECur*) pObject;
	////////////////////////////////////////////////////////////////////// Curve
...
void CSLECur::SetObjectInfo(CSLEObj* pObject)
{
...
int CSLECur::Get_Values_Iso_Node(CDrNode* pNodeIsoTo, STALPROC StaLProc,CString& CurrentID)
{
	m_pSNodeT = NULL;
	m_pSNodeR = NULL;
	/////////////////////////////////////////////////////////////////////////
...
int CSLECur::ShowCurveStaticLoad(CDrCurve* pCurrentCurve,CString* pID,int nHowMany)
{
	///////////////////////////////////////////////////////////////////////
...
int CSLECur::Get_Values_Iso_Cur(CDrCurve* pCurveIsoTo, STALPROC StaLProc, int IndexSkipNode,
																	BOOL bLastCurve)
{
...
void CSLECur::RemoveMostListsFromCurve(CDrCurve* pAdd)
{
...
int CSLECur::Generate_IsoCurveControls(CDrCurve* pCurveIsoTo,int indexC,CString* pID,BOOL bTran)
{
...
int CSLECur::Get_Values_NonIso_Cur(STALPROC StaLProc)
{
	AfxMessageBox("Get_Values_NonIso_Cur\nNOT IMPLEMENTED YET");
	return -1;
}

int CSLECur::ShowInfo_CurveStaticLoad(CDrCurve* pDrCurve, char* buf, int jStart,CString& CurrentStLID)
{
	int j = jStart;
	///////////////
	CDListMgr* pList;
	...
	for(i=0;i<pList->GetCount();i++)
	{
		...
		{
			AfxMessageBox("Internal ERROR:\nCSLECur::FillInfo_CurveStaticLoad\npDrLinSup=NULL"); 
			return -2;
		}
		/////////////////////////////////////////
...
void CSLECur::Serialize(CArchive& ar)
{

	CSLENod::Serialize( ar);              // must call base class Serializer
	////////////////////////////
	if (ar.IsStoring())
	{
