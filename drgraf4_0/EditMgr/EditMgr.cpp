...
#endif
/////////////////////////////////////////////////// resource switch
extern AFX_EXTENSION_MODULE NEAR extensionEMgr_DLL;
/////////////////////////////////////////////////////////////////////////////
// CElemObj

IMPLEMENT_SERIAL(CEditMgr,CObject,1)
/*
BEGIN_MESSAGE_MAP(CEditMgr,CObject)
//BEGIN_MESSAGE_MAP
	//{{AFX_MSG_MAP(CEditMgr)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/ 
////////////////////////////
CEditMgr::CEditMgr()
{
	...
	AfxSetResourceHandle(extensionEMgr_DLL.hModule); // uses client's instance handle 
...
UINT CEditMgr::ReSetToolID(UINT CntlID,UINT IGenID, UINT OperID)
{
...
/*
UINT CEditMgr::ReSetToolID_Mesh(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	BOOL bMeshMode = pWnd->IsMeshMode();	// TRUE = MESH Mode/  FALSE = GENERATOR Mode
	////////////////////////////////////////////
...
*/
LPOINT3 CEditMgr::GetStatusMouseWIC()
{
	return m_StatusMouseWIC;
}

void CEditMgr::SetStatusMouseWIC(LPOINT3 StatWIC)
{
...
void CEditMgr::SetViewCursor(int nType)
{
	///////////////////////////////////////////// If helpMode, no-op
...
// CEditMgr serialization

void CEditMgr::Serialize(CArchive& ar)
{
