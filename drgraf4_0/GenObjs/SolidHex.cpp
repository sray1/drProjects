// CSolidHex.cpp : implementation of the CSolidHex class
//
...
IMPLEMENT_DYNAMIC(CSolidHex,CObject)
/*
BEGIN_MESSAGE_MAP(CSolidHex,CObject)
//BEGIN_MESSAGE_MAP
	//{{AFX_MSG_MAP(CSolidHex)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/
/////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////
int CSolidHex::HO_MakeSolides		// RATIONAL BEZIER Solides
			(
			...
			)
{
	...
	int		nt_U,nt_V,nt_W, U[MAX_CON_CURVE],
			V[MAX_CON_CURVE], W[MAX_CON_CURVE],
			vIx[MAX_CON_CURVE][MAX_CON_CURVE][MAX_CON_CURVE];	// vertex indices
	BOOL	bLast_U,bLast_V,bLast_W;
	int		nMaxU,nMaxV;
	////////////////////////////////////// memory for array of pointers
	PW444 pInC_444 = new pWORLD[MAX_CON_CURVE][MAX_CON_CURVE][MAX_CON_CURVE];	//	Control Pt. array for the Solid: RESERVED for Maximum Cubic
	PD444 pInW_444 = new pDOUBLE[MAX_CON_CURVE][MAX_CON_CURVE][MAX_CON_CURVE]; 
	/////////////////////////////////////////////////////// Totals in UV dir
	int nEmitTot_U=0;
		...
		for( V[0] = v = 0; v < nSolides_V; v++, V[0]+=CtlStep_V ) 
		{
			...
			for( U[0] = u = 0; u < nSolides_U; u++, U[0]+=CtlStep_U ) 
			{
				...
				if(nOut != nEmitTot_CurUCurVCurW)
				{
					...
					delete [] pInW_444;
					//////////////////
					AfxMessageBox("CSolidHex::HO_MakeSolides\nnOutS != nMaxUVW");
					return -1;
				}	
				else
				{	
...
{
    /////////////////////////////////
	WORLD		C_R[MAX_CON_CURVE][MAX_CON_CURVE];
	pWORLD		p_R;
	double 		W_R[MAX_CON_CURVE][MAX_CON_CURVE];
	pDOUBLE		pw_R;
	...
	double	t		= -delr;				
	//////////////////////////////// memory
	PW44 pCon_S4T4	= new pWORLD[MAX_CON_CURVE][MAX_CON_CURVE];	//	Control Pt. array for the patch: RESERVED for Maximum Cubic
	PD44 pWts_S4T4	= new pDOUBLE[MAX_CON_CURVE][MAX_CON_CURVE]; 
	...
	for (ir=0;ir<nMaxR;ir++)
	{
		...
		for(i=0;i<=nDegree_S;i++)			
		{
			for(j=0;j<=nDegree_T;j++)
			{
				...
				HO_ComputeMG(ppCon_R4,ppWts_R4,
										pMG_1,pMG_2,pMG_3,nDegree_R,nDim_R);
				/////////////////////////////////////////////////////////////// Curve Pt. in W-dir
				HO_Make_A_CurvePt_V(pMG_1,pMG_2,pMG_3,nDegree_R,nDim_R,t,&C_R[i][j],&W_R[i][j]);
				///////////////
				pCon_S4T4[i][j] 	= &C_R[i][j];	// pointer transfer
				pWts_S4T4[i][j]		= &W_R[i][j];	// that's why C_R & W_R are arrayed/saved
				//////////////////////////////////////////////////////////////////////////// Memory :Free
...
//////////////////////////////////////////////////// View Matrices
	...
	if(1 != 1 ) // 
	{
 	   ...
 	   ///////////////////////////////////////////
		sprintf(buf,"CSolidHex::HO_Make_A_Solid-Just before Calling HO_Make_A_Solid\nir = %d",ir);
		AfxMessageBox(*str);
		///////////////////
		int j,k,m;
	    ///////////////////
...
//////////////////////////////////////////////////////////////////
		...
		if(nOutST != nMax_ST)
		{
			...
			delete [] ppWts_R4;
			//////////////////
			AfxMessageBox("CSolidHex::HO_Make_A_Solid\nnOutST != nMaxST");
			return -1;
		}											
		else
		{	
...
//////////////////////////////////////////////////////////////////////
int	CSolidHex::TensorProduct_3D
				(
...
//						pMCoef_1,pMCoef_2,pMCoef_3,
	...
	{
		//////////////////
		AfxMessageBox("CSolidHex::TensorProduct_Surfaces\nnPtActual != nOut");
		return -1;
	}		
    else
		return nPtActual;
...
//	PDMA44 pMCoef_3 = (PDMA44)CoefBezierCubic;	// Cubic
	...
	if(1 != 1 ) // 
	{
		...
		char* buf = str->GetBuffer(BUFF_SIZE);
 	   ///////////////////////////////////////////
		sprintf(buf,"Just in CSolidHex::TensorProduct");
		AfxMessageBox(*str);
		///////////////////
		int j,k,m;
	    ///////////////////
