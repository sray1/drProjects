...
{ 
	...
	/////////////////////////////////////////////////////////////////// NOTE
	//	In MakeTangents_A_Patch:
	//		It is always the PARTIALS wrt V that are computed
	//		So, for PARTIALS wrt U: Parametric directions should be
	//					 SWITCHED by the calling routine
////////////////////////////////////////////////////////////////////////////
int CPat_Tan4::MakeTangents		// RATIONAL BEZIER Patches
			(
