...
public:
	...
	virtual int		GetExtruType_T(){return m_nExtruType_T;};
	virtual void	SetExtruType_T(int nSegs){m_nExtruType_T = nSegs;};
	virtual double	GetLength_T(){return m_dLen_T;};
	virtual void	SetLength_T(double dLen){m_dLen_T = dLen;};
	////////////////////////////////////////////////////////////////// for Type 2 Input
	virtual WORLD	GetWorldLength_T(){return m_wLen_T;};
	virtual void	SetWorldLength_T(WORLD wLen){m_wLen_T = wLen;};
	//////////////////////////////////////////////////////////////////
	...
	virtual int		Generate_Tangent3(pWORLD pOut_S,int nDir_1,pWORLD pOut_T,int nDir_2);	// Triangular Patches
	virtual int 	Generate_Normal3(pWORLD pOut);					// Triangular Patch Normals
																	//		Tangents ALREADY Known
	virtual int		Generate_Tangents_N_Normal3(pWORLD pOut);		// Quadrilateral Patch Normals
	///////
	virtual int 	Generate_Patch4(pWORLD pOut, pDOUBLE pOutWts);	// Quadrilateral Patches
	virtual int		Generate_Tangent4(pWORLD pOut, int nDir);		// Quadrilateral Patch Tangents
	virtual int 	Generate_Normal4(pWORLD pOut);					// Quadrilateral Patch Normals
																	//		Tangents ALREADY Known
	virtual int		Generate_Tangents_N_Normal4(pWORLD pOut);		// Quadrilateral Patch Normals
	///////
	virtual pWORLD	GetPtrTangents_S(){return m_pTangents_S;};
	virtual pWORLD	GetPtrTangents_T(){return m_pTangents_T;};
	virtual pWORLD	GetPtrNormals(){return m_pNormals;};
	///////
...
*/
	...
	virtual WORLD	GetWorldTwistMult_T(){return m_wTwistMult_T;};
	virtual void	SetWorldTwistMult_T(WORLD dLen){m_wTwistMult_T = dLen;};
	virtual WORLD	GetWorldTwistStart_T(){return m_wTwistStart_T;};
	virtual void	SetWorldTwistStart_T(WORLD dLen){m_wTwistStart_T = dLen;};
	virtual WORLD	GetWorldScaleMult_T(){return m_wScaleMult_T;};
	virtual void	SetWorldScaleMult_T(WORLD dLen){m_wScaleMult_T = dLen;};
	virtual WORLD	GetWorldScaleStart_T(){return m_wScaleStart_T;};
	virtual void	SetWorldScaleStart_T(WORLD dLen){m_wScaleStart_T = dLen;};
	///////////////////////////////////////////////////////////////////// Triangular Patch
	...
	///////////////////////////////////////////////////////////////////// Mesh
	virtual BOOL 	CullWorld(WORLD VDir);
