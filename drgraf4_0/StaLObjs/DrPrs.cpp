...
/////////////////////////////////////////////////////////////////////////////
// CDrPrs
IMPLEMENT_SERIAL(CDrPrs, CDrObject,1)
/*
BEGIN_MESSAGE_MAP(CDrPrs, CDrObject)
	//{{AFX_MSG_MAP(CDrPrs)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrPrs::SetObjectInfo(CDrObject* pObject)
{
	
	CDrObject::SetObjectInfo(pObject);	
	////////////////////////////////////////////////////////   
	CDrPrs* pAdd = (CDrPrs*) pObject;
	///////////////////////////////////////////////////// SuppINFO
...
void CDrPrs::GetObjectInfo(CDrObject* pObject)
{
...
void CDrPrs::DoDataView(CDC* PtrDC, int y)
{
...
void CDrPrs::Pack_drPipe(CString* pstrCard)
{
...
int CDrPrs::Calc_3DBoundsLocal(pWORLD pOut, int nPts)
{
...
//////////////////////////////////////////////////////////
void CDrPrs::TransformObjectToWorld(pMATRIX pLM,BOOL bYes)
{
	////////////////////////
...
void CDrPrs::TransformObjectToView(pMATRIX pViewM)
{
...
void CDrPrs::TransformObjectToViewDirect
...
BOOL CDrPrs::RemoveHiddenObject(pMATRIX pViewM,WORLD VDir,int nType)
{
		return FALSE;	// do nothing
}			 
				
void CDrPrs::ProjectObject
...
int CDrPrs::GetApproDataLen(int direction)
{
...
void CDrPrs::GetApproPts(WORLD pOut[],int nPts,int direction)
{
	int i;
	////////////
	switch(direction)
...
void CDrPrs::TransformToWorldPos(pMATRIX pLM,BOOL bYes)
{
	AfxMessageBox("CDrPrs::TransformToWorldPos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	pMATRIX		pLMP;	
	int i;
...
void CDrPrs::TransformToEyePos(pMATRIX pViewM)
{
	AfxMessageBox("CDrPrs::TransformToEyePos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	int i;
	CXForm XForm;
...
void CDrPrs::TransformToEyePosDirect
				(pMATRIX pLM,pMATRIX pViewM,pMATRIX pComposedM,BOOL bYes)
{
...
void CDrPrs::ProjectToScreenPos
				(pMATRIX pvv3DM,double dScale_U,double dScale_V)
{
...
void CDrPrs::Calc_ScreenRectFromCNodes()
{
	/////////////////////
	Rearrange2DCorners();
	FinishObject();
...
void CDrPrs::Rearrange2DCorners()
{ 
...
//////////////////////////////////////////////////////////////
void CDrPrs::InitDraw(CDC* PtrDC,BOOL bParallel,int nView,
...
//////////////////////////////////////////////////////////////
void CDrPrs::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDrPrs::GoDoIt(CDC* PtrDC, int direction)
{ 
...
void CDrPrs::GoConnect_Force(CDC* PtrDC)
{ 
...
void CDrPrs::GoConnect_Moment(CDC* PtrDC)
{ 
...
//////////////////////////////////////////////////////////////////
BOOL CDrPrs::IsKeyMatch(CDrObject* pObject, CString KeyID,UINT KeyNo)
{

				
	CDrPrs* pStaL = (CDrPrs*)(pObject);
	///////////////////////////////////////////// SupID
...
void CDrPrs::Serialize(CArchive& ar)
{
...
BOOL CDrPrs::IsObjectHit(int nNet,POINT point)
{
	/////////////// TODO
	return FALSE;
	///////////////
