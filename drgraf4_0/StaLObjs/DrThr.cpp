...
/////////////////////////////////////////////////////////////////////////////
// CDrThr
IMPLEMENT_SERIAL(CDrThr, CDrObject,1)
/*
BEGIN_MESSAGE_MAP(CDrThr, CDrObject)
	//{{AFX_MSG_MAP(CDrThr)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrThr::SetObjectInfo(CDrObject* pObject)
{
	
	CDrObject::SetObjectInfo(pObject);	
	////////////////////////////////////////////////////////   
	CDrThr* pAdd = (CDrThr*) pObject;
	///////////////////////////////////////////////////// SuppINFO
...
void CDrThr::GetObjectInfo(CDrObject* pObject)
{
...
void CDrThr::DoDataView(CDC* PtrDC, int y)
{
...
void CDrThr::Pack_drPipe(CString* pstrCard)
{
...
int CDrThr::Calc_3DBoundsLocal(pWORLD pOut, int nPts)
{
...
//////////////////////////////////////////////////////////
void CDrThr::TransformObjectToWorld(pMATRIX pLM,BOOL bYes)
{
	////////////////////////
...
void CDrThr::TransformObjectToView(pMATRIX pViewM)
{
...
void CDrThr::TransformObjectToViewDirect
...
BOOL CDrThr::RemoveHiddenObject(pMATRIX pViewM,WORLD VDir,int nType)
{
		return FALSE;	// do nothing
}			 
				
void CDrThr::ProjectObject
...
int CDrThr::GetApproDataLen(int direction)
{
...
void CDrThr::GetApproPts(WORLD pOut[],int nPts,int direction)
{
	int i;
	////////////
	switch(direction)
...
void CDrThr::TransformToWorldPos(pMATRIX pLM,BOOL bYes)
{
	AfxMessageBox("CDrThr::TransformToWorldPos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	pMATRIX		pLMP;	
	int i;
...
void CDrThr::TransformToEyePos(pMATRIX pViewM)
{
	AfxMessageBox("CDrThr::TransformToEyePos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	int i;
	CXForm XForm;
...
void CDrThr::TransformToEyePosDirect
				(pMATRIX pLM,pMATRIX pViewM,pMATRIX pComposedM,BOOL bYes)
{
...
void CDrThr::ProjectToScreenPos
				(pMATRIX pvv3DM,double dScale_U,double dScale_V)
{
...
void CDrThr::Calc_ScreenRectFromCNodes()
{
	/////////////////////
	Rearrange2DCorners();
	FinishObject();
...
void CDrThr::Rearrange2DCorners()
{ 
...
//////////////////////////////////////////////////////////////
void CDrThr::InitDraw(CDC* PtrDC,BOOL bParallel,int nView,
...
//////////////////////////////////////////////////////////////
void CDrThr::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDrThr::GoDoIt(CDC* PtrDC, int direction)
{ 
...
void CDrThr::GoConnect_Force(CDC* PtrDC)
{ 
...
void CDrThr::GoConnect_Moment(CDC* PtrDC)
{ 
...
//////////////////////////////////////////////////////////////////
BOOL CDrThr::IsKeyMatch(CDrObject* pObject, CString KeyID,UINT KeyNo)
{

				
	CDrThr* pStaL = (CDrThr*)(pObject);
	///////////////////////////////////////////// SupID
...
void CDrThr::Serialize(CArchive& ar)
{
...
BOOL CDrThr::IsObjectHit(int nNet,POINT point)
{
	/////////////// TODO
	return FALSE;
	///////////////
