...
/*
	////////////////////////////////////////////////////////////////// xz-plane
	{.1*WIDTH,	0.0,0.0			},{.1*WIDTH,	0.0,.7*LENGTH	},		 
    {.2*WIDTH,	0.0,.7*LENGTH	},{0.0,			0.0,LENGTH		},		 
    {-.2*WIDTH,	0.0,.7*LENGTH	},{-.1*WIDTH,	0.0,.7*LENGTH	},		 
    {-.1*WIDTH,	0.0,0.0			},
	////////////////////////////////////////////////////////////////// yz-plane
	{0.0,.1*WIDTH,	0.0			},{0.0,.1*WIDTH,	.7*LENGTH	},		 
    {0.0,.2*WIDTH,	.7*LENGTH	},{0.0,0.0,			LENGTH		},		 
...
/////////////////////////////////////////////////////////////////////////////
// CDrF_M
IMPLEMENT_SERIAL(CDrF_M, CDrObject,1)
/*
BEGIN_MESSAGE_MAP(CDrF_M, CDrObject)
	//{{AFX_MSG_MAP(CDrF_M)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrF_M::SetObjectInfo(CDrObject* pObject)
{
	
	CDrObject::SetObjectInfo(pObject);	
	////////////////////////////////////////////////////////   
	CDrF_M* pAdd = (CDrF_M*) pObject;
	///////////////////////////////////////////////////// SuppINFO
...
void CDrF_M::GetObjectInfo(CDrObject* pObject)
{
...
void CDrF_M::DoDataView(CDC* PtrDC, int y)
{
...
void CDrF_M::Pack_drPipe(CString* pstrCard)
{
...
int CDrF_M::Calc_3DBoundsLocal(pWORLD pOut, int nPts)
{
...
//////////////////////////////////////////////////////////
void CDrF_M::TransformObjectToWorld(pMATRIX pLM,BOOL bYes)
{
	////////////////////////
...
void CDrF_M::TransformObjectToView(pMATRIX pViewM)
{
...
void CDrF_M::TransformObjectToViewDirect
...
BOOL CDrF_M::RemoveHiddenObject(pMATRIX pViewM,WORLD VDir,int nType)
{
		return FALSE;	// do nothing
}			 
				
void CDrF_M::ProjectObject
...
int CDrF_M::GetApproDataLen(int direction)
{
...
void CDrF_M::GetApproPts(WORLD pOut[],int nPts,int direction)
{
	int i;
	////////////
	switch(direction)
...
void CDrF_M::TransformToWorldPos(pMATRIX pLM,BOOL bYes)
{
	AfxMessageBox("CDrF_M::TransformToWorldPos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	pMATRIX		pLMP;	
	int i;
...
void CDrF_M::TransformToEyePos(pMATRIX pViewM)
{
	AfxMessageBox("CDrF_M::TransformToEyePos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	int i;
	CXForm XForm;
...
void CDrF_M::TransformToEyePosDirect
				(pMATRIX pLM,pMATRIX pViewM,pMATRIX pComposedM,BOOL bYes)
{
...
void CDrF_M::ProjectToScreenPos
				(pMATRIX pvv3DM,double dScale_U,double dScale_V)
{
...
void CDrF_M::Calc_ScreenRectFromCNodes()
{
	/////////////////////
	Rearrange2DCorners();
	FinishObject();
...
void CDrF_M::Rearrange2DCorners()
{ 
...
//////////////////////////////////////////////////////////////
void CDrF_M::InitDraw(CDC* PtrDC,BOOL bParallel,int nView,
...
//////////////////////////////////////////////////////////////
void CDrF_M::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDrF_M::GoDoIt(CDC* PtrDC, int direction)
{ 
...
void CDrF_M::GoConnect_Force(CDC* PtrDC)
{ 
...
void CDrF_M::GoConnect_Moment(CDC* PtrDC)
{ 
...
//////////////////////////////////////////////////////////////////
BOOL CDrF_M::IsKeyMatch(CDrObject* pObject, CString KeyID,UINT KeyNo)
{

				
	CDrF_M* pStaL = (CDrF_M*)(pObject);
	///////////////////////////////////////////// SupID
...
void CDrF_M::Serialize(CArchive& ar)
{
...
BOOL CDrF_M::IsObjectHit(int nNet,POINT point)
{
	/////////////// TODO
	return FALSE;
	///////////////
