...
/////////////////////////////////////////////////////////////////////////////
// CDrLWt
IMPLEMENT_SERIAL(CDrLWt, CDrObject,1)
/*
BEGIN_MESSAGE_MAP(CDrLWt, CDrObject)
	//{{AFX_MSG_MAP(CDrLWt)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
*/  
...
void CDrLWt::SetObjectInfo(CDrObject* pObject)
{
	
	CDrObject::SetObjectInfo(pObject);	
	////////////////////////////////////////////////////////   
	CDrLWt* pAdd = (CDrLWt*) pObject;
	///////////////////////////////////////////////////// SuppINFO
...
void CDrLWt::GetObjectInfo(CDrObject* pObject)
{
...
void CDrLWt::DoDataView(CDC* PtrDC, int y)
{
...
void CDrLWt::Pack_drPipe(CString* pstrCard)
{
...
int CDrLWt::Calc_3DBoundsLocal(pWORLD pOut, int nPts)
{
...
//////////////////////////////////////////////////////////
void CDrLWt::TransformObjectToWorld(pMATRIX pLM,BOOL bYes)
{
	////////////////////////
...
void CDrLWt::TransformObjectToView(pMATRIX pViewM)
{
...
void CDrLWt::TransformObjectToViewDirect
...
BOOL CDrLWt::RemoveHiddenObject(pMATRIX pViewM,WORLD VDir,int nType)
{
		return FALSE;	// do nothing
}			 
				
void CDrLWt::ProjectObject
...
int CDrLWt::GetApproDataLen(int direction)
{
...
void CDrLWt::GetApproPts(WORLD pOut[],int nPts,int direction)
{
	int i;
	////////////
	switch(direction)
...
void CDrLWt::TransformToWorldPos(pMATRIX pLM,BOOL bYes)
{
	AfxMessageBox("CDrLWt::TransformToWorldPos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	pMATRIX		pLMP;	
	int i;
...
void CDrLWt::TransformToEyePos(pMATRIX pViewM)
{
	AfxMessageBox("CDrLWt::TransformToEyePos\nSHOULD NOT BE CALLED");
	return;
	/////////////////////
	int i;
	CXForm XForm;
...
void CDrLWt::TransformToEyePosDirect
				(pMATRIX pLM,pMATRIX pViewM,pMATRIX pComposedM,BOOL bYes)
{
...
void CDrLWt::ProjectToScreenPos
				(pMATRIX pvv3DM,double dScale_U,double dScale_V)
{
...
void CDrLWt::Calc_ScreenRectFromCNodes()
{
	/////////////////////
	Rearrange2DCorners();
	FinishObject();
...
void CDrLWt::Rearrange2DCorners()
{ 
...
//////////////////////////////////////////////////////////////
void CDrLWt::InitDraw(CDC* PtrDC,BOOL bParallel,int nView,
...
//////////////////////////////////////////////////////////////
void CDrLWt::DoDrawView(CDC* PtrDC,BOOL bPenChange)
{
...
void CDrLWt::GoDoIt(CDC* PtrDC, int direction)
{ 
...
void CDrLWt::GoConnect_Force(CDC* PtrDC)
{ 
...
void CDrLWt::GoConnect_Moment(CDC* PtrDC)
{ 
...
//////////////////////////////////////////////////////////////////
BOOL CDrLWt::IsKeyMatch(CDrObject* pObject, CString KeyID,UINT KeyNo)
{

				
	CDrLWt* pStaL = (CDrLWt*)(pObject);
	///////////////////////////////////////////// SupID
...
void CDrLWt::Serialize(CArchive& ar)
{
...
BOOL CDrLWt::IsObjectHit(int nNet,POINT point)
{
	/////////////// TODO
	return FALSE;
	///////////////
