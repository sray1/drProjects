...
////////////////////////////////////
IMPLEMENT_SERIAL(CSLDMdit,CSupEdit,1)
/////////////////////////////////////////////////////////////////////////////
CSLDMdit::CSLDMdit()
{
}
...
void CSLDMdit:: ElementLeftDown_SLD()
{	
...
void CSLDMdit::OnEBoxLButtonDown_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
...
void CSLDMdit::FillStaticInfo(CDrStatic* pStatic)
{
...
void CSLDMdit::UpdateSLEObjInfo()
{
...
int CSLDMdit::LeftUp_NodeStatic(CPoint point)
{
...
int CSLDMdit::LeftUp_CurveStatic(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
	///////////////////////////////////////////////////////////////////////
...
int CSLDMdit::LeftUp_PatchStatic(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
	///////////////////////////////////////////////////////////////////////
...
void CSLDMdit::ElementLeftUp_SLD(CPoint point)
{                          
...
void CSLDMdit::OnEBoxMouseMove_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{  
...
void CSLDMdit::OnEBoxLButtonUp_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSLDMdit::OnEBoxRButtonDown_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
									UINT nFlags, CPoint point)
{ 
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSLDMdit::OnEBoxRButtonUp_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
								UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
////////////////////////////////////////////////////////////////////	
UINT CSLDMdit::ReSetToolID_SLD(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CString strCur;
	////////////////
...
void CSLDMdit::Serialize(CArchive& ar)
{
