...
////////////////////////////////////
IMPLEMENT_SERIAL(CRegen3D,CMouse,1)
/////////////////////////////////////////////////////////////////////////////
CRegen3D::CRegen3D()
{
}
...
int CRegen3D::Update3Ds(CDrFE0D* pDrNode)
{
...
int CRegen3D::ReGen_EditedElemNodes(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	...
	switch(ObjType)
	{
		...
		case QU_16:
			...
			break;
		default:
			AfxMessageBox("ERROR:\nCRegen3D::ReGen_EditedElemNodes\nUNKNOWN 2D ELEMENT!");
			return -1;
	}
	/////////
	return 0;
...
int CRegen3D::ReComputeAddlNodeCoords_TR_3(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Nothing to do
	return 0;
}

int CRegen3D::ReComputeAddlNodeCoords_TR_6(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_TR_6\nNodeIndex Not Found");
		return -1;
	}
...
int CRegen3D::ReComputeAddlNodeCoords_TR_9(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_TR_9\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
int CRegen3D::ReComputeAddlNodeCoords_TR_10(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_TR_10\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
int CRegen3D::ReComputeAddlNodeCoords_QU_4(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Nothing to do
	return 0;
}

int CRegen3D::ReComputeAddlNodeCoords_QU_8(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_QU_8\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
int CRegen3D::ReComputeAddlNodeCoords_QU_9(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_QU_9\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
int CRegen3D::ReComputeAddlNodeCoords_QU_12(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_QU_12\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
int CRegen3D::ReComputeAddlNodeCoords_QU_16(CDrFE1D* pElemToEdit,CDrFE0D* pEditedNode)
{
	// Which Corner Node Changed
	CDListMgr* pListV = pElemToEdit->GetFE0DList();
	int index = pListV->GetObjectIndex((CObject*)pEditedNode);
	...
	if(index<0)
	{
		AfxMessageBox("ERROR:\nCRegen3D::ReComputeAddlNodeCoords_QU_16\nNodeIndex Not Found");
		return -1;
	}
	/////////////////////////////////////////////////////// Recompute Affected Coords
	CMsMath		MsMath;
...
///////////////////////////////////////
void CRegen3D::Serialize(CArchive& ar)
{
	...
	if (ar.IsStoring())
	{
		TRACE(" CRegen3D:    Storing\n");	
		

	}
	else
	{
		TRACE(" CRegen3D:    Loading\n");	
