...
////////////////////////////////////
IMPLEMENT_SERIAL(CSLDCreOp,CSupCreOp,1)
/////////////////////////////////////////////////////////////////////////////
CSLDCreOp::CSLDCreOp()
{
}
...
void CSLDCreOp:: ElementLeftDown_SLD()
{	
...
void CSLDCreOp::OnEBoxLButtonDown_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
...
void CSLDCreOp::FillStaticInfo(CDrStatic* pStatic)
{
...
void CSLDCreOp::UpdateSLEObjInfo()
{
...
int CSLDCreOp::LeftUp_NodeStatic(CPoint point)
{
...
//			j = m_SLEPat.ShowInfo_NodeStaticLoad(pDrNode, buf, j,pStatic);
	...
	////////////////////////////////////////////////////////////////
	int nAnyway = -12345; // ???????????????????
	if(m_SLEPat.ShowNodeStaticLoad(m_pCurrentNode,pCurrentLabel,pID,nAnyway)<0)		// 
	{
		AfxMessageBox("ERROR:\nCSLDCreOp::LeftUp_NodeStatic\nShowNodeStaticLoad Problem");
		return -1;
	}
	////////////////////////////////////////////////////////////////
...
int CSLDCreOp::LeftUp_CurveStatic(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
	///////////////////////////////////////////////////////////////////////
...
// to do********/////////////////////////////// if Supported, only Displace/rot Allowed 
	...
	pWnd->UpdateCurrStat(strCurr);
	////////////////////////////////////////////////////////////////
	if(m_SLEPat.ShowCurveStaticLoad(m_pCurrentCurve,pID,nAnyway)<0)		// 
	{
...
int CSLDCreOp::LeftUp_PatchStatic(CPoint point)
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)(AfxGetApp()->m_pMainWnd);
	CString strCurr;
	///////////////////////////////////////////////////////////////////////
...
// to do********/////////////////////////////// if Supported, only Displace/rot Allowed 
	...
	pWnd->UpdateCurrStat(strCurr);
	////////////////////////////////////////////////////////////////
	if(m_SLEPat.ShowPatchStaticLoad(m_pCurrentPatch,pID,nAnyway)<0)		// 
	{
		AfxMessageBox("ERROR:\nCSLDCreOp::LeftUp_PatchStatic\nShowPatchStaticLoad Problem");
		return -1;
	}
	////////////////////////////////////////////////////////////////
...
void CSLDCreOp::ElementLeftUp_SLD(CPoint point)
{                          
...
void CSLDCreOp::OnEBoxMouseMove_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{  
...
void CSLDCreOp::OnEBoxLButtonUp_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSLDCreOp::OnEBoxRButtonDown_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
									UINT nFlags, CPoint point)
{ 
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSLDCreOp::OnEBoxRButtonUp_SLD(CClientDC* pdc,CView* pView,GENERATE gener,
								UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
////////////////////////////////////////////////////////////////////	
UINT CSLDCreOp::ReSetToolID_SLD(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CString strCur;
	////////////////
...
void CSLDCreOp::SetMainType_SLD()
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)AfxGetMainWnd();
	/////////////////////////////////////////////////////////
...
void CSLDCreOp::Serialize(CArchive& ar)
{
