...
protected:
	...
	int		SpawnNodeListinSolid(CDListMgr* pFillList, pMATRIX pXFMat);
	int		SpawnNodeinSolid(CDrNode* pOldNode,CDrNode* pNewNode,pMATRIX pXFMat);
	...
	int		SpawnListsInSolidCopyOff(pMATRIX pXFMat);
