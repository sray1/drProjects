...
////////////////////////////////////
IMPLEMENT_SERIAL(CSupCreOp,CSolCreOp,1)
/////////////////////////////////////////////////////////////////////////////
CSupCreOp::CSupCreOp()
{
...
void CSupCreOp:: ElementLeftDown_SUP()
{	
...
void CSupCreOp::NoRigidEdit_Msg()
{
...
int CSupCreOp::ShowNodeLinSuppToEdit()
{
...
int CSupCreOp::ShowCurveLinSuppToEdit()
{
...
int CSupCreOp::ShowPatchLinSuppToEdit()
{
...
int CSupCreOp::ShowSolidLinSuppToEdit()
{
	return -1;
}

void CSupCreOp::OnEBoxLButtonDown_SUP(CClientDC* pdc,CView* pView,GENERATE gener,
...
int CSupCreOp::ShowInfo_NodeLinSupport(CDrNode* pDrNode, char* buf, int jStart)
{
	int j = jStart;
	////////////////////////////////////////
	...
	if(pList->GetCount() > 2)
	{
		AfxMessageBox("Internal ERROR:\nCSupCreOp::FillInfo_NodeLinSupport\npList->GetCount() > 2"); 
		return -2;
	}
	////////////////////////////////////////////////////////////////////////
	int i;
...
int CSupCreOp::FillInfo_Rigid(SUPPCARD supCard,char* buf, int jStart)
{
...
int CSupCreOp::FillInfo_SprOrSnu(CString& Nid,SUPPCARD supCard,char* buf, int jStart,BOOL bPat)
{
	CString dir[] = {"X","Y","Z"};
	//////////////////////////////
...
int CSupCreOp::LeftUp_NodeLinSupp(CPoint point)
{
	///////////////////////////////////////////////////////////////////////
	CDrGrafDoc* pDoc 			= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr(); 
...
int CSupCreOp::ShowInfo_CurveLinSupport(CDrCurve* pDrCurve, char* buf, int jStart)
{
	int j = jStart;
	///////////////
	CDListMgr* pList;
	...
	if(pList->GetCount() > 2)
	{
		AfxMessageBox("Internal ERROR:\nCSupCreOp::ShowInfo_CurveLinSupport\npList->GetCount() > 2"); 
		return -2;
	}
	////////////////////////////////////////////////////////////////////////
	int i;
...
int CSupCreOp::LeftUp_CurveLinSupp(CPoint point)
{
	///////////////////////////////////////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr();
...
int CSupCreOp::ShowInfo_PatchLinSupport(CDrPatch* pDrPatch, char* buf, int jStart)
{
	int j = jStart;
	///////////////
	CDListMgr* pList;
	...
	if(pList->GetCount() > 2)
	{
		AfxMessageBox("Internal ERROR:\nCSupCreOp::ShowInfo_PatchLinSupport\npList->GetCount() > 2"); 
		return -2;
	}
	////////////////////////////////////////////////////////////////////////
	int i;
...
int CSupCreOp::LeftUp_PatchLinSupp(CPoint point)
{
	///////////////////////////////////////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr  = pDoc->GetObjectMgr();
...
int CSupCreOp::ShowInfo_SolidLinSupport(CDrSolid* pDrSolid, char* buf, int jStart)
{
	return -1;
}

int CSupCreOp::LeftUp_SolidLinSupp(CPoint point)
{
	return -1;
}

void CSupCreOp::ElementLeftUp_SUP(CPoint point)
{                          
...
void CSupCreOp::OnEBoxMouseMove_SUP(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{  
...
void CSupCreOp::OnEBoxLButtonUp_SUP(CClientDC* pdc,CView* pView,GENERATE gener,
											UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSupCreOp::OnEBoxRButtonDown_SUP(CClientDC* pdc,CView* pView,GENERATE gener,
									UINT nFlags, CPoint point)
{ 
	m_nFlags				= nFlags;
	m_pView					= pView;
...
void CSupCreOp::OnEBoxRButtonUp_SUP(CClientDC* pdc,CView* pView,GENERATE gener,
								UINT nFlags, CPoint point)
{
	m_nFlags				= nFlags;
	m_pView					= pView;
...
////////////////////////////////////////////////////////////////////	
UINT CSupCreOp::ReSetToolID_SUP(UINT CntlID,UINT IGenID, UINT OperID)
{
	CDrGrafFrame* pWnd	= (CDrGrafFrame*)AfxGetMainWnd();
	CString strCur;
	////////////////
...
void CSupCreOp::SetMainType_SUP()
{
	CDrGrafFrame* pWnd		= (CDrGrafFrame*)AfxGetMainWnd();
	/////////////////////////////////////////////////////////
...
void CSupCreOp::Serialize(CArchive& ar)
{
