...
CDlg_SpnC::CDlg_SpnC(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_SpnC::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_SpnC)
	m_SpawnID	= _T("");
	m_CID = _T("");
	//}}AFX_DATA_INIT
	m_pMatObj	= NULL;
...
void CDlg_SpnC::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SpnC)
...
BEGIN_MESSAGE_MAP(CDlg_SpnC, CDialog)
	//{{AFX_MSG_MAP(CDlg_SpnC)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SpnC message handlers

BOOL CDlg_SpnC::OnInitDialog() 
{
...
///////////////////////////////////////////////////////
void CDlg_SpnC::FillListAllString_Pool()
{
	// with CURVES
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
...
void CDlg_SpnC::FillListAllCurveIDs()
{
...
void CDlg_SpnC::SetInfoForDataBase(CDrCurve* pDrObject)
{
	///////////////////////////////////////
	CDrGrafDoc* pDoc 		= ((CDrGrafApp*)AfxGetApp())->GetDocument();
	CObjectMgr* pObjectMgr 	= pDoc->GetObjectMgr();
...
//	if(!(pDrObject->GetElemList()->IsEmpty()) )		// 01/13/1998 Stores Handle Node,
//		pDrObject->GetElemList()->RemoveAll();		// Center for Circle_By_Rot/Circle_By_3No w/o Arc
