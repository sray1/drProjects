...
protected:
	...
	int				LeftUp_NODE_NodeContext(CPoint point,BOOL bCNode);
	int				LeftUp_Node_Accept_NodeContext(CPoint point,BOOL bCNode,BOOL bMNode);
	int				ShowNodeInfo_SameID(CDrNode* pDrNode);
	int				ShowNodeInfo_SameCoords_NodeContext(CDrNode* pDrNode);
    ////////////////////////////////////////
	...
	//////////////////////////////////////////////////////////
//	int				NodTopo_Update(CDrNode* pEndNode,CDrNode* pOtherNode);
