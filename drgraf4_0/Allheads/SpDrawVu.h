// 12View.h : interface of the CSpDrawVu class
//
#ifndef _SPDRAWVU_H 
#define _SPDRAWVU_H 
...
class CSpDrawVu : public CAxDrawVu
{
protected: // create from serialization only
	CSpDrawVu();
	DECLARE_DYNCREATE(CSpDrawVu)
...
inline CDrGrafDoc* CSpDrawVu::GetDocument()
