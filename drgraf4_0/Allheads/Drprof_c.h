...
//	virtual	int 		Calc_3DBounds();		//ConvexHull of CNodes
    ////////////////////////////////////////////////
    CDListMgr*	GetCurveList(){return &m_CurveList;};	// curves
    CDListMgr*	GetLMList(){return &m_LMList;};	// Local Matrix
//	CMatObj*	GetMatObj(){return m_pMatObj;};			// LocalM Input Info for later Editing
//	void		SetMatObj(CMatObj* cM){m_pMatObj = cM;};
    ////////////////////////////////////////////////
    CDrCurve*	GetCurve(){return m_pCurve;};	// curves
    void		SetCurve(CDrCurve* pC){m_pCurve = pC;};
    PROFILETYPE	GetProfileType(){return m_ProfType;};	// curves
    void		SetProfileType(PROFILETYPE p){m_ProfType = p;};
...
//	CMatObj*	m_pMatObj;		// Local Transform Input Info for later Editing
	...
	PROFILETYPE	m_ProfType;		// PRT_BLEND/PRT_STITCH
