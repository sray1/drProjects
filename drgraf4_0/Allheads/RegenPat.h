...
// CMouse view
//////////////////////////////////////////////////////
class AFX_EXT_CLASS CRegenPat : public CMouse
{
public:
...
protected:
	...
	int				ReGen_Controls_LOFTX(CDrPatch* pEditedPatch,CString* pID);
	int				ReGen_Controls_GORDON(CDrPatch* pEditedPatch,CString* pID);
	int				ReGen_Controls_TENSOR(CDrPatch* pEditedPatch,CString* pID);
