...
#include "Def_CuPS.h" 
////////////////////////////                   
//typedef	double (*PDMA3)[4]; in glbType.h
/////////////////////////////////////////////////////////////////////////////
// CMouse view
//////////////////////////////////////////////////////
class CInter_C2 : public CObject
{
public:

	CInter_C2();
//////////////////////////////////////
	DECLARE_SERIAL(CInter_C2)
//////////////////////////////////////
...
protected:
	...
	int		SwitchDataAroundIf_BCR(pWORLD Data,enum WEIGHT WtType,pDOUBLE Wts,int nData,
										BOUNDARY& BC_L,BOUNDARY& BC_R,
										VECTOR& ETan_L,VECTOR& ETan_R);
	int		SwitchControlsBackIf_BCR(pWORLD Con_BS,pDOUBLE Wts_BS,int nCon_BS,
