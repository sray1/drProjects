...
IMPLEMENT_DYNCREATE(CDlg_SI_EndCond, CSasePage)

CDlg_SI_EndCond::CDlg_SI_EndCond(): CSasePage()
{
	m_bCornerMode	= 0;
	m_bEditMode = 0;
}

CDlg_SI_EndCond::CDlg_SI_EndCond(CWnd* pMainWnd,SOLIDPROC SolProc)
					: CSasePage(pMainWnd,SolProc,CDlg_SI_EndCond::IDD)
{
	//{{AFX_DATA_INIT(CDlg_SI_EndCond)
	m_strBCL 	= "AUTO";
	m_strBCR 	= "AUTO";
	m_bRightOn 	= TRUE;
	m_bLeftOn 	= TRUE;
...
void CDlg_SI_EndCond::DoDataExchange(CDataExchange* pDX)
{
	CSasePage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SI_EndCond)
...
BEGIN_MESSAGE_MAP(CDlg_SI_EndCond, CSasePage)
	//{{AFX_MSG_MAP(CDlg_SI_EndCond)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SI_EndCond message handlers
BOOL CDlg_SI_EndCond::OnInitDialog() 
{
...
void CDlg_SI_EndCond::OnDefault() 
{
    ///////////////////
...
void CDlg_SI_EndCond::OnAllSame() 
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::OnSelchangeComboNode() 
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::OnSelchangeComboDir() 
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::OnSelchangeComboTwist() 
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::ResetDlgForTwist()
{
	CDrNode* pNode;
	POSITION pos;
	int index;
...
void CDlg_SI_EndCond::ResetDlgForEdit()
{
	SetIsoDir();
	SetNodeIDs();
	SetIendJendBoolText();
...
void CDlg_SI_EndCond::FillBndryNodeIDCombo(CList<CString,CString>& BndryList)
{
...
void CDlg_SI_EndCond::FillOthers(int index,CList<BLENDEND,BLENDEND>* pEndList)
{
...
void CDlg_SI_EndCond::SetIsoDir()
{
    /////////////////// 
 	CComboBox* pCombo;
	////////////////////////////////////////////////// Change LEFTBoundaryCombo
...
void CDlg_SI_EndCond::SetNodeIDs()
{
	CDrNode* pNode;
	POSITION pos;
	int index;
...
int CDlg_SI_EndCond::GetIndexJ(int indexI, BOOL bU)
{
	if(bU) // U-dir Curve
...
void CDlg_SI_EndCond::SetIendJendBoolText()
{
	if(m_NodeID_I != "")
...
void CDlg_SI_EndCond::SetEndListIndex()
{
	//////////////////
	if(m_bU)
...
void CDlg_SI_EndCond::BuildBndryNodeList()
{
	if(m_NodeID == "")
		return;
	//////////////////
...
void CDlg_SI_EndCond::SetIendJendCombos()
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::OnBcLeftOn()
{
    ////////////////////
	UpdateData(TRUE);		    //FROM Screen(TRUE)    
    ///////////////////
...
void CDlg_SI_EndCond::OnBcRightOn()
{
    ////////////////////
	UpdateData(TRUE);		    //FROM Screen(TRUE)    
    ///////////////////
...
void CDlg_SI_EndCond::OnSelchangeBcLeft()
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    ///////////////////
...
void CDlg_SI_EndCond::OnSelchangeBcRight()
{
    ///////////////////
	UpdateData(TRUE);		    //From Screen(TRUE)    
    /////////////////// 
...
void CDlg_SI_EndCond::UpdateDataBase_BC(int nNodeIndex,CList<BLENDEND,BLENDEND>* pEndList)
{
...
void CDlg_SI_EndCond::UpdateDataBase_Twist()
{
	int i,j;
	////////////////////////////////////////////////// Corner Twist
	if(!m_bCornerMode)
