...
#define wEQL(a,b)	((a).x ==(b).x) && ((a).y ==(b).y) \
					&& ((a).z ==(b).z)  
////////////////////////////////////
IMPLEMENT_SERIAL(CMP_LoftX,CMI_GangS,1)
/////////////////////////////////////////////////////////////////////////////
CMP_LoftX::CMP_LoftX()
{
}
...
//////////////////////////////////////////////////////////////////////////////////////////////
// LoftX Solids Could be arising out of 2 situations:
//		//////////////////////////																		
//		1. As Part of Gordon Solids
//			In this Case:
//				bGordonPart		=	TRUE;
//		//////////////////////////																		
//		2. As StandAlone w/ Lattice Patches in UV 
//			In this Case:
//				bGordonPart		=	FALSE;
//////////////////////////////////////////////////////////////////////////////////////////////
int CMP_LoftX::GoDoIt 
				(
					...
					int								nNodes_V,
					int								nNodes_W,
					CDListMgr*						pNodeList,	// Contains CNodes of Patches
					//////////////////////////////////////////
				...
				) 
{
	...
	//////////////////////////////////
	m_bGordon	= bGordon;
	nTotData	= nNodes_U * nNodes_V * nNodes_W;
	//////////////////////////////////////////////////////////
	int nResult = MA_OK;
	//////////////////////////////////////////////////////////
	m_PatchID	= PatchID;
