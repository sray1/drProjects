...
////////////////////////////////////
IMPLEMENT_SERIAL(CMS_Duc3,CMI_GangP,1)
/////////////////////////////////////////////////////////////////////////////
CMS_Duc3::CMS_Duc3()
{
}
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
BOOL CMS_Duc3::IsDataCompatible(CDListMgr* pNodeList,
...
int CMS_Duc3::TwistProcess(pDOUBLE pTwist, int nTwist, double dScaleMax, double dTwistStart,
																		BOOL bIncremental)
{
	int		i;
	////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Duc3::SetSolidDataFromPatch(CDrPatch* pPatch)
{
	///////////////////////////////////////////////////////////////////////////////////
...
int CMS_Duc3::GetPatCNodeCoords_N_Wts_XSection(CDrPatch* pPatch, PATCHLATCH pLatch, 
...
//////////////////////////////////////////////////////////////////////////////////////
int CMS_Duc3::GetSolidInfoFromSpine_R(CDrCurve* pCurve)
{
	int i;
	pINT	pNum_t_R;
	pDOUBLE	pDis_t_R;
...
int CMS_Duc3::GetCNodeCoords_N_WtsAtJnPts_Spine(CDrCurve* pCurve, CURVELATCH cLatch, 
									pWORLD pConOld, pDOUBLE pWtsOld)
{
...
int CMS_Duc3::CreateTangentsAtJnPts_Spine(CDrCurve* pCurve,CURVELATCH cLatch,pWORLD pTangents)
{
...
int CMS_Duc3::SolCNCoords_N_WtsAtJns(WORLD wAnchorPt,pWORLD pPatConBZ_ST,pDOUBLE pPatWtsBZ_ST,
...
int CMS_Duc3::PostSolBezInfoUsingBlendingInfo(CDrSolid* pSolid,CDrCurve* pSpineCurve,
...
int CMS_Duc3::PostPatBezInfo(CDrSolid* pSolid,CDListMgr& TemCNodeList,pDOUBLE pTemSolWts_BZ,
...
int CMS_Duc3::TempPostSolBezJunctionPtsInINodeList(pWORLD pConBZ,int nConBZ_ST,int nRowCol,
...
int CMS_Duc3::PackSolBezJunctionWtsInDataWtsArray(pDOUBLE pWtsBZ,int nConBZ_ST,int nRowCol,
...
int CMS_Duc3::GenerateSolidBezInfoFromSpineCurve(
...
int CMS_Duc3::Copy_N_TransferBezControlInfo(CDrCurve* pCurve,CDListMgr* pSolCNodeList,
...
int CMS_Duc3::Copy_N_TransferBezWeightInfo(CDrCurve* pCurve,pDOUBLE pPatWts_BZ,int nCon_R,int nRowCol)
{
	pDOUBLE pWts	= pCurve->GetpWts_BZ_S(); 
...
/////////////////////////////////////////////////////////////////////////////////////
int CMS_Duc3::SetInfoForDataBase(CDrSolid* pDrObject,
...
void CMS_Duc3::SetInfoForDataBase_1(CDrSolid* pDrObject,
...
//////////////////////////////////////////////////////////////////////////////////////
void CMS_Duc3::Serialize(CArchive& ar)
{
