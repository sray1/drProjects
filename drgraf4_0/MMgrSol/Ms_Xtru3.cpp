...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Xtru3::ProceessLength_N_Axis(int nExtruType,double& dLen,WORLD& wLen)
{
	///////////////////////////////////////
...
BOOL CMS_Xtru3::IsDataCompatible(CDListMgr* pPatchList,CDListMgr* pNodeList,
								CList<PATCHLATCH,PATCHLATCH>*	pLatchList,
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Xtru3::SetSolidDataFromPatch(CDrPatch* pPatch)
{
	///////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////
int CMS_Xtru3::ExtrudeCNs_N_WtsOfPatch(
					pWORLD							pPatConBZ, 	
					pDOUBLE							pPatWtsBZ, 	
					int								nPatConBZ,
					//////////////////////////////////////////////
...
int CMS_Xtru3::PostSolCNodes_N_Wts(CDrSolid* pDrSolid,pWORLD pConBZ,pDOUBLE pWts_BZ,
...
/////////////////////////////////////////////////////////////////////////////////////
int CMS_Xtru3::GetPatCNodeCoords_N_Wts(CDrPatch* pPatch, PATCHLATCH pLatch, 
...
int CMS_Xtru3::GetSolidInfo_R(CList<int,int>* pElperSegList,double Ratio)
{
	m_nSegs_R	= 1;
	m_Ratio_R	= Ratio;
	m_pOSeg		= NULL;
...
//////////////////////////////////////////////////////////////////////////////////////
int CMS_Xtru3::SetInfoForDataBase(CDrSolid* pDrObject,
...
void CMS_Xtru3::SetInfoForDataBase_1(CDrSolid* pDrObject,
