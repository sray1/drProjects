				...
				) 
{
	...
	PostSolCNodes_N_Wts(pDrSolid,pConBZ,pWtsBZ,m_nMaxSolidCNodes_S,
									m_nMaxSolidCNodes_ST,m_nMaxSolidCNodes_R);
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Rota3::ProceessCoordAxis(int nAxis,BOOL bNeg)
{
...
BOOL CMS_Rota3::IsDataCompatible(CDListMgr* pPatchList,CDListMgr* pNodeList,
								CList<PATCHLATCH,PATCHLATCH>*	pLatchList,
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Rota3::SetSolidDataFromPatch(CDrPatch* pPatch)
{
	///////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////
int CMS_Rota3::RevolveCNs_N_WtsOfPatch(
					pWORLD				pPatConBZ, 	
					pDOUBLE				pPatWtsBZ, 	
					int					nPatConBZ,
					//////////////////////////////////////////////
...
int CMS_Rota3::PostSolCNodes_N_Wts(CDrSolid* pDrSolid,pWORLD pConBZ,pDOUBLE pWts_BZ,
											int nConBZ_S,int nConBZ_ST,int nConBZ_R)
{
	...
	////////////////////////////////////////////////////////// CNodes & Wts
	for(r=0;r<nConBZ_R;r++)
	{
		////////////////////////////////////
		for (i = 0; i<nConBZ_S; i++)
		{
			for (j = 0; j<nConBZ_S-i; j++)
			{
				k = nConBZ_S - i - j - 1; 
				//////////////////////////////////// Name
				CString* pNid = new CString;
				char* buf = pNid->GetBuffer(BUFF_SIZE);
				sprintf(buf,"%s_%d_%d_%d_%d",SolidID,i,j,k,r);
				//////////////////////////////////// Barycentric to Linear
				m = BARY2LIN_PT(i,j,nConBZ_S) + r * nConBZ_ST;
				////////////////////////////////////////////////// Regular 
				wLocalPos = pConBZ[m];
				////////////////////////////////////////////////// Create & Save
...
/////////////////////////////////////////////////////////////////////////////////////
int CMS_Rota3::GetPatCNodeCoords_N_Wts(CDrPatch* pPatch, PATCHLATCH pLatch, 
...
int CMS_Rota3::GetSolidInfo_R(CList<int,int>* pElperSegList,double Ratio,double dAng)
{
	//	ElperSegList_W:
			// ist record: elem/seg
			// 2nd record: #of BezSeg
...
//////////////////////////////////////////////////////////////////////////////////////
int CMS_Rota3::SetInfoForDataBase(CDrSolid* pDrObject,
...
void CMS_Rota3::SetInfoForDataBase_1(CDrSolid* pDrObject,
