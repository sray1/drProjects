...
IMPLEMENT_DYNCREATE(CDlg_SI_Revolv, CSasePage)

CDlg_SI_Revolv::CDlg_SI_Revolv(): CSasePage()
{
}

CDlg_SI_Revolv::CDlg_SI_Revolv(CWnd* pMainWnd,SOLIDPROC SolProc)
				: CSasePage(pMainWnd,SolProc,CDlg_SI_Revolv::IDD)
{
	//{{AFX_DATA_INIT(CDlg_SI_Revolv)
	m_nMesh		= 1;
	m_bClosed	= FALSE;
	m_dCoord	= 0.0;
	m_nTotElems = 1;
...
CDlg_SI_Revolv::~CDlg_SI_Revolv()
{
}

void CDlg_SI_Revolv::DoDataExchange(CDataExchange* pDX)
{
	CSasePage::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_SI_Revolv)
...
BEGIN_MESSAGE_MAP(CDlg_SI_Revolv, CSasePage)
	//{{AFX_MSG_MAP(CDlg_SI_Revolv)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_SI_Revolv message handlers
BOOL CDlg_SI_Revolv::OnInitDialog()
{
...
void CDlg_SI_Revolv::ResetDlg()
{
	...
	GetDlgItem(IDC_PIDHEAD)->SetWindowText("Rotnl. Patch");
...
void CDlg_SI_Revolv::OnGenBCurve() 
{
    ////////////////////
...
void CDlg_SI_Revolv::OnGenBPatch() 
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_SI_Revolv::OnSelchangeSid() 
{
	// TODO: Add your control notification handler code here
	
}

void CDlg_SI_Revolv::OnSelchangePid() 
{
    ////////////////////
	UpdateData(TRUE);			//FROM Screen(TRUE)    
    ///////////////////	
...
void CDlg_SI_Revolv::FillListAllString_Patch()
{
...
void CDlg_SI_Revolv::FillListAllString_Solid()
{
...
void CDlg_SI_Revolv::FillListAllString_Node()
{
...
void CDlg_SI_Revolv::OnAxisX() 
{
	m_nAxis = 1;
}

void CDlg_SI_Revolv::OnAxisY() 
{
	m_nAxis = 2;
}

void CDlg_SI_Revolv::OnAxisZ() 
{
	m_nAxis = 3;
}

void CDlg_SI_Revolv::OnNegative() 
{
	UpdateData(TRUE);
	/////////////////
...
void CDlg_SI_Revolv::OnKillfocusCoord() 
{
	/////////////////
	UpdateData(TRUE);
	/////////////////
	if(m_pWnd !=NULL)
		m_pWnd->SendMessage(ID_UPDATE_SOLIN,IDC_COORD);
}
/////////////////////////// end of module //////////////
