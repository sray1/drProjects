...
CDlg_Swip_S::CDlg_Swip_S(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_Swip_S::IDD, pParent)
{
	buttonOK.LoadBitmaps("Image1Up","Image1Down","Image1Focus");
	buttonCancel.LoadBitmaps("Image2Up","Image2Down","Image2Focus");
	//{{AFX_DATA_INIT(CDlg_Swip_S)
	m_CID_Spine		= "";
	m_CID_Twist		= "";
	m_CID_Xsec		= "";
	m_PatchID		= "";
...
void CDlg_Swip_S::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_Swip_S)
	...
	DDX_CBString(pDX, IDC_ORIENT_RAD, m_Orient_3);
	DDX_Check(pDX, IDC_CONTROLNODE, m_bCNode);
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CDlg_Swip_S, CDialog)
	//{{AFX_MSG_MAP(CDlg_Swip_S)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_Swip_S message handlers

BOOL CDlg_Swip_S::OnInitDialog()
{
	...
	if(nMaxSolides)
		FillListAllSolidIDs();   //  with Patches
	///////////////////////////////////////////////
...
void CDlg_Swip_S::FillListAllString()
{
...
void CDlg_Swip_S::FillListAllSolidIDs()
{
...
void CDlg_Swip_S::FillListAllPatchIDs()
{
...
void CDlg_Swip_S::FillListAllCurveIDs()
{
...
void CDlg_Swip_S::SetInfoForDataBase(CDrSolid* pDrObject)
{
	...
	pDrObject->SetIncScale_R(m_bIncRad);
	pDrObject->SetTwistMult_R(m_TwistMult);
	pDrObject->SetScaleMult_R(m_RadiusMult);
	pDrObject->SetTwistStart_R(m_TwistStart);
	pDrObject->SetScaleStart_R(m_RadStart);
	pDrObject->NumberOfElements(S_DUCT,1/*int nElemType*/); // temp:1=LINE
	////////////////////////////////////////////////	
