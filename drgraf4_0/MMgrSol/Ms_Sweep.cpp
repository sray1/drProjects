...
#define wEQL(a,b)	((a).x ==(b).x) && ((a).y ==(b).y) \
					&& ((a).z ==(b).z)  
////////////////////////////////////
IMPLEMENT_SERIAL(CMS_Sweep,CMI_GangP,1)
/////////////////////////////////////////////////////////////////////////////
CMS_Sweep::CMS_Sweep()
{
}
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
BOOL CMS_Sweep::IsDataCompatible(CDListMgr* pNodeList,
...
int CMS_Sweep::TwistProcess(pDOUBLE pTwist, int nTwist, double dScaleMax, double dTwistStart,
																		BOOL bIncremental)
{
	int		i;
	////////////////////////////
...
int CMS_Sweep::ScaleProcess(pDOUBLE pTwist, int nTwist, double dScaleMax, double dTwistStart,
																		BOOL bIncremental)
{
	int		i;
	////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////// PreProcess
int CMS_Sweep::SetSolidDataFromPatch(CDrPatch* pPatch)
{
	int i;
	pINT	pNum_t_S;
	pDOUBLE	pDis_t_S;
...
int CMS_Sweep::GetPatCNodeCoords_N_Wts_XSection(CDrPatch* pPatch, PATCHLATCH pLatch, 
...
//////////////////////////////////////////////////////////////////////////////////////
int CMS_Sweep::GetSolidInfoFromSpine_R(CDrCurve* pCurve)
{
	int i;
	pINT	pNum_t_R;
	pDOUBLE	pDis_t_R;
...
int CMS_Sweep::GetCNodeCoords_N_WtsAtJnPts_Spine(CDrCurve* pCurve, CURVELATCH cLatch, 
									pWORLD pConOld, pDOUBLE pWtsOld)
{
...
int CMS_Sweep::CreateTangentsAtJnPts_Spine(CDrCurve* pCurve,CURVELATCH cLatch,pWORLD pTangents)
{
...
int CMS_Sweep::SolCNCoords_N_WtsAtJns(WORLD wAnchorPt,pWORLD pPatConBZ_ST,pDOUBLE pPatWtsBZ_ST,
...
int CMS_Sweep::PostSolBezInfoUsingBlendingInfo(CDrSolid* pSolid,CDrCurve* pSpineCurve,
...
int CMS_Sweep::PostPatBezInfo(CDrSolid* pSolid,CDListMgr& TemCNodeList,pDOUBLE pTemSolWts_BZ,
...
int CMS_Sweep::TempPostSolBezJunctionPtsInINodeList(pWORLD pConBZ,int nConBZ_ST,int nRowCol,
...
int CMS_Sweep::PackSolBezJunctionWtsInDataWtsArray(pDOUBLE pWtsBZ,int nConBZ_ST,int nRowCol,
...
int CMS_Sweep::GenerateSolidBezInfoFromSpineCurve(
...
int CMS_Sweep::Copy_N_TransferBezControlInfo(CDrCurve* pCurve,CDListMgr* pSolCNodeList,
...
int CMS_Sweep::Copy_N_TransferBezWeightInfo(CDrCurve* pCurve,pDOUBLE pPatWts_BZ,int nCon_R,int nRowCol)
{
	pDOUBLE pWts	= pCurve->GetpWts_BZ_S(); 
...
/////////////////////////////////////////////////////////////////////////////////////
int CMS_Sweep::SetInfoForDataBase(CDrSolid* pDrObject,
...
void CMS_Sweep::SetInfoForDataBase_1(CDrSolid* pDrObject,
