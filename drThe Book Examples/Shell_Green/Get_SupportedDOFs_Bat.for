	Subroutine Get_SupportedDOFs_Bat(Sx,nSup,nQc,iCont,iOut)
!	STraight beam in xy plane formulated as in 3D
	...
	Dimension		DropC06( 6),DropC16(4),DropC26(4)	! Straight Beam	
!---------------------------
...
!------------------------------------
   ...
   60			Sx(i) = DropC26(i)
	...
	call DumpIntegerArray(Sx,nSup,"Supported DOFs",1,iOut)
!-----------   	
	return
	end
