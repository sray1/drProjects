	Subroutine Form_a_N_kc_N_AMat(iDir,Iout)
!	----------------------------------------------------------------------------- 
!	Inputs
...
!			call DumpVar(iOut)
			...
			call DumpRealArray(Dp1,3,"Dp1           ",iPrt,iOut)
			call DumpRealArray(Rp1,3,"Rp1           ",iPrt,iOut)
			call DumpRealArray(Dp2,3,"Dp2           ",iPrt,iOut)
			call DumpRealArray(Rp2,3,"Rp2           ",iPrt,iOut)
			call DumpRealArray(C0 ,3,"C01           ",iPrt,iOut)
			call DumpRealArray(AA ,3,"AA1           ",iPrt,iOut)
			...
			call DumpRealArray(CK,3,"CK1            ",iPrt,iOut)
