	Subroutine Quad_CC_STIF(Qc,nQc,Nel,NelType,Nint,E,PR,Thk,Rad,
...
!----------------------------------------------------------- Cubic_Cubic
!	Call CC_StrainDispMat(Qc,nQc,Ri,Si,B,nStif,Rad,Depth,4,4,
!     &								Det,Nel,NelType,Iout)	
!----------------------------------------------------------- Quartic_Quartic
	Call CC_StrainDispMat(Qc,nQc,Ri,Si,B,nStif,Rad,Depth,5,5,
     &								Det,Nel,NelType,Iout)
!	write(*,1020) ri,si
!	do 10 i = 1,3
...
!	Pause
  110	continue
	return
!
 1000 format("Strain-Disp Matrix:Stif(3,32)"/
     &        I5/(4(8(f10.6,1X)/)/))
