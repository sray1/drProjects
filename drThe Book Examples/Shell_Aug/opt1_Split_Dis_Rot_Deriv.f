	Subroutine Opt1_Split_Dis_Rot_Deriv(Qd,nStif,B,Iout)
!
...
!	------------------------------------------------------------------- H(dHat):Incremental
	...
	call VectorExtract_Vector(HD,nG,Dp1,nC,7,Iout)	    !displacementPrimed_1
	call VectorExtract_Vector(HD,nG,Rp1,nC,10,Iout)	    !rotationPrimed_1
	call VectorExtract_Vector(HD,nG,Dp2,nC,13,Iout)	    !displacementPrimed_2
	call VectorExtract_Vector(HD,nG,Rp2,nC,16,Iout)	    !rotationPrimed_2
