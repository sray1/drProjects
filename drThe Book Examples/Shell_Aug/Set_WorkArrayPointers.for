...
!	n5V			= n5			+ nQc1*nSzDbl			!	Assumed load at the end along y			
	nAugMul     = nEndW			! 	Start HERE			
	nAugMulO    = nAugMul		+ Nint1*Nint2*nSzDbl			! 				
	nPenalt     = nAugMulO		+ Nint1*Nint2*nSzDbl			! 				
	nPenaltO    = nPenalt		+ Nint1*Nint2*nSzDbl			! 				
	nOldCon     = nPenaltO		+ Nint1*Nint2*nSzDbl			! 				
	nRoCOld     = nOldCon		+ Nint1*Nint2*nSzDbl			! 				
