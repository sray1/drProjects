...
!	=======================================================
	write(iOut,1020) pen,iAugIterMax,Tol_Aug,Tol_Con,
     &				 TOL,ArcLen,MaxSteps,MaxIt,iCutMax,
     &				 Nint1,Nint2,Nint
!	------
	return
 1020 Format(/ 5x,"Solution Controls"/
     &	2x,"Penalty								= ",G12.5/
     &	2x,"Max. Number of Augment Iteration 	= ",G12.5/
     &	2x,"Augment Tolerance					= ",G12.5/
     &	2x,"Constraint Tolerance				= ",G12.5/
