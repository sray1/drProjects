	Subroutine AddGBlocks_Con_J3(nF,nC,G12,G22,G23,iCurDir,Iout)
!	----------------------------------------------------------------------------- 
!	Inputs
...
!	========
	if(iCurDir == 1) then
		G12 = MATMUL(MATMUL(W,-SHat),E11)
		G22 = MATMUL(MATMUL(W,-SHat),E12)	
		G23 = MATMUL(MATMUL(W,-SHat),E13)	
	elseif (iCurDir == 2) then 
		G12 = MATMUL(MATMUL(W,-SHat),E31)
		G22 = MATMUL(MATMUL(W,-SHat),E32)	
		G23 = MATMUL(MATMUL(W,-SHat),E35)	
	endif
!---------------------------------------------------------- Write:
	iPrt = 0
	if (iPrt == 1) Then
...
!
 1000	format(A,I5,A)
 1005 format(1X,"Current direction for GC_Matrix_J3 ="I2/)
