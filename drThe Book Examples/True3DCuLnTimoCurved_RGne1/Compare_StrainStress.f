	Subroutine Compare_StrainStress_2EL(XP,Qc,nQc,Qd,nQd,P2,
...
!
	Real(kind=8)	XP   ,Qc       ,E,R,Depth,Width,Radius,P2
...
!
	...
	ri = delri*(i-1)
!------------------------------------- Dtrain-Disp
	Call QQ_StrainDispMat(XP,Qc,nQc,ri,Radius,Br,nQd,Det,Axes,
