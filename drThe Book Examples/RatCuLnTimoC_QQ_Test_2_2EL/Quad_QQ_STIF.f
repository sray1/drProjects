...
!
	Real(kind=8)	Qx,     Qy     ,GeomWt
	Dimension		Qx(nQc),Qy(nQc),GeomWt(nQc)
...
!
	write(Iout,1000) Nel,(i,(Qc(i,j),j=1,3),i=1,3)
...
!	Get Geometry: 
!
	call RatControlsWts(Qc,Qx,Qy,GeomWt,nQc,Nel,Iout)

!
!	Get Strain Displacement Matrix: B(3,32)
!
	call QQ_StrainDispMat(Qx,Qy,GeomWt,nQc,Ri,Radius,B,nStif,Det,
     &								Nel,NelType,Iout)
!
