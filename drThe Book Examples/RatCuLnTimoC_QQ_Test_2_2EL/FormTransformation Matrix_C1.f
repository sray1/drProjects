...
!	DATA LocW  / 4,13/			! these and
	DATA LocW  / 4,15/			! these and
!	DATA DofU  /10/			!To be removed by
!	DATA LocU  / 8,17/			! these and
!	DATA LocU  / 8,18/			! these and
!	DATA DofR  /15/			!To be removed by
!	DATA LocR  /12,21/			! these and
!----------------------------------------------- Quintic:nQc=6
