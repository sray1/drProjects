	Program RationalCurvilinear_Timo_QQ_Test2_2ELs
!
...
!-------------------------------------------------
	Nel			= 1
	nPLStart	= 0
	call RatBZ_CoordsWts_EL1(A(n1a),3,nQc,RADIUS,A(nPlot),nPLDim,
...
!-------------------------------------------------
	Nel			= 2
	nPLStart	= nPLs - 1
	call RatBZ_CoordsWts_EL2(A(n1b),3,nQc,RADIUS,A(nPlot),nPLDim,
     &								nPLs,nPLStart,Nel,iOut)
!	-------------------------------------|-----|--------
...
!
	Stop 'OK'
 1000 Format(/ 5x,"TestCase II: 2 Elements --"/ 
     &		 5x,"******	RATIONAL BEZIER Formulation ******"//
