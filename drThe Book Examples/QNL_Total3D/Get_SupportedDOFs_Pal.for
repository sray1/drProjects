	Subroutine Get_SupportedDOFs_Pal(Sx,nSup,nQc,iCont,iOut)
!	Curved beam Palazotto
	integer			Sx
	Dimension		Sx(nSup)
	integer			DropC05    ,DropC15   ,DropC25   
	Dimension		DropC05(18),DropC15(4),DropC25(4)	
	integer			DropC06    ,DropC16   ,DropC26   
!	Dimension		DropC06(22),DropC16(4),DropC26(4)	! Palazzotto				SAVE01/28/04	
	Dimension		DropC06(8),DropC16(4),DropC26(4)	! Palazzotto				SAVE01/29/04	
!---------------------------
...
!
!---------------------------
	DATA DropC06 / 1,             6,	!u				! Palazzotto				SAVE01/29/04
     &               7,					!w
!     &			  13,14,15,16,17,18,		!v
     &			  13,			 18,	!v
...
!     &              25,26,27,28,29,30,    !theta_m
     &                             36/	! Support Condition for Quintic (nQc = 6)
