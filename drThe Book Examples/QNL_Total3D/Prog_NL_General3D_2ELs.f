...
!======================================================================= save
		...
		call PutGetRotCur(iRotCur,A(nRoCOld),A(nCuCOld),nCInt,nRec,1)
    3		continue
    4		continue					
!======================================================================= save:End
...
!
	write(IoutDef,1040) float(iPlotCountDef),float(nDis)
	write(IoutEnd,1040) float(1),float(iPlotCountEnd)
!	------------------------------------------------------------- MatLab Plot End
	iPlot = 1
	if(iPlot == 1) Then
		iPltType = 2
