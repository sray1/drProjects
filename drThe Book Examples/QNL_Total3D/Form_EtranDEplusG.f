...
!	if((iStep == 1).AND.(iNut == 2)) Then
		write(Iout,1005) (i,(EMat(i,j),j = 1,nDof2),i=1,nDof)
...
!
 ...
 1005 format("EMat(6,12)"/(I3,12(f5.2,1X)))
 1040 format(2X, "EDG Matrix(12,12)"/(I3,12(f6.0,1X)))
 1050 format(2X, "G Matrix(12,12)"  /(I3,12(f8.0,1X)))
	end
