	Subroutine DeformOut_MatLab_ARG(XLF,THETAL,Qd,nQd,nQc,nDof,
...
!	===========================
	...
	character (30)	cEx
!	===========================
	Data			zero/0.D0/,one/1.D0/,two/2.D0/,onm/-1.D0/
!------------------------------
...
!--------------------------------------------------- Curvilinear-->Cartesian
	call QQ_TMB_CuLn(Qc,nQc,nQc,ri,Det,Curvature,Torsion,Axes,
     &							dxbardr,Nel,Iout,0)
!============================================================ ARGYRIS: Frame Special HARDCODE
	if(nEx == 6) Then
		Cur		= zero
		Tor		= zero
		Axes	= zero
...
!============================================================ ARGYRIS: Frame Special HARDCODE END
