	Subroutine Quad_CC_STIF4(Qc,nQc,Nel,NelType,Nint,E,PR,xLen1,xLen2,
     &						yLen,Thk,Stif,nStif,Iout,Trace)
!
...
!----------------------------------------------------------- Quartic_Quartic
	Call CC_StrainDispMat(Qc,nQc,Ri,Si,B,nStif,xLen1,xLen2,yLen,5,5,
     &								Det,Nel,NelType,Iout)
!	write(*,1020) ri,si
!	do 10 i = 1,3
...
!	Pause
  110	continue
	return
!
 1000 format("QC(2,25): Elem# =",I4/
     &        (I5,5X,5(f10.6,1X)/4(10X,5(f10.6,1X)/)) )
