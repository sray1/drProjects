# Microsoft Developer Studio Generated NMAKE File, Based on QNL_Gen3D.dsp
!IF "$(CFG)" == ""
CFG=QNL_Gen3D - Win32 Debug
!MESSAGE No configuration specified. Defaulting to QNL_Gen3D - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "QNL_Gen3D - Win32 Release" && "$(CFG)" != "QNL_Gen3D - Win32 Debug"
...
F90_OBJS=.\Release/
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /Fp"$(INTDIR)\QNL_Gen3D.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /win32 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\QNL_Gen3D.bsc" 
BSC32_SBRS= \
	
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"WinMainCRTStartup" /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\QNL_Gen3D.pdb" /machine:I386 /nodefaultlib:"dfconsol.lib" /out:"$(OUTDIR)\QNL_Gen3D.exe" 
LINK32_OBJS= \
...
"$(OUTDIR)\QNL_Gen3D.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
F90_OBJS=.\Debug/
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /Fp"$(INTDIR)\QNL_Gen3D.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /entry:"WinMainCRTStartup" /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\QNL_Gen3D.pdb" /debug /machine:I386 /nodefaultlib:"dfconsol.lib" /out:"$(OUTDIR)\QNL_Gen3D.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\Augment_Load_ArcLen.obj" \
	"$(INTDIR)\Augment_STIF_ArcLen.obj" \
	"$(INTDIR)\BernStein.obj" \
...
!IF EXISTS("QNL_Gen3D.dep")
!INCLUDE "QNL_Gen3D.dep"
!ELSE 
!MESSAGE Warning: cannot find "QNL_Gen3D.dep"
!ENDIF 
!ENDIF 
