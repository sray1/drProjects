...
!	=========================================================== Quintic/Quintic
!	DATA AddC06 /73,103/! Load Condition for Quintic (nQd = 6) tipForce freeend dis3 CURVILINEAR
	DATA AddC06 / 1, 67/! Load Condition for Quintic (nQd = 6) tipForce freeend dis3 CARTESIAN
!------------------------------------
	Fact(1) = 1.D0
	Fact(2) = -1.D0
