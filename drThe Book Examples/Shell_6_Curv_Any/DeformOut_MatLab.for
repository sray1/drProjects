...
!     &				nPStep,iOut,IoutDef,EndwSav,Qc,Nel)
     ...
     &                                 	iOut,IoutDef,EndwSav,Nel)
			endif
			if(bPlot) then
				if(nEx == 10.AND.nElem == 4) then
					call DeformOut_MatLab_Hem4(SLamdam,Qd,Qc,Conv,sign
     &                                 ,iter,iOut,IoutDef,EndwSav,Nel)
				elseif(nEx == 10.AND.nElem == 1) then
					call DeformOut_MatLab_Hem(SLamdam,Qd,Qc,Conv,sign
     &                                 ,iter,iOut,IoutDef,EndwSav,Nel)
				endif
			endif
