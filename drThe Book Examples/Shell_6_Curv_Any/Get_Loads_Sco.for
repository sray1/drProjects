	Subroutine Get_Loads_Sco(LocF,ValF,nLod,nQd1,nQd2,iCont,iOut)
...
!	=========================================================== Quintic/Quintic
	DATA AddC06 /108/! Load Condition for Quintic (nQd = 6) tipForce freeend dis3
!------------------------------------
	Fact = -1.D0
