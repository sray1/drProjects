	Subroutine CC_StrainDispRAT(W,Qc,nDim,nQc1,nQc2,nQc,nQd,R,S,B,nB,
...
!		------------------------------------------------------------ Geometry: Jacobian & Determinant
		call Jacobian_N_DeterminantRAT(W,Qc,nDim,nQc1,nQc2,R,S,
     &                 	              A1,A2,Det)
	else
...
!
	call Calc_Coords_at_a_Pt_RAT(Coord,Qc,W,nDim,nQc1,nQc2,R,S)
