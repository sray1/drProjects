	Subroutine Form_ConstitutiveMatrix(DMat,nCM,iOut)
...
!
	...
	DMat( 5, 5)		= DBen			!M12	k12		: Bending	eM11
	DMat( 5,10)		= DBP			!		k21 
	DMat(10, 5)		= DMat( 5,10)	!M21	k12			       	   
	DMat(10,10)		= DBen			!		k21		: Bending  -eM22
