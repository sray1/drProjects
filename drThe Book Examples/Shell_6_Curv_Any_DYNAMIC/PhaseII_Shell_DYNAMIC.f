	subroutine PhaseII_Shell_DYNAMIC()
!-------------------------
	include 'Implicit.h'
!========================================================================
	include 'Blank.h'
...
!===========================================================================================STEP 1 INITIALIZE
		call LoadStep_1_iter_1_DYNAMIC()
...
!		--------------------------------------------------------- Extract END Element DisRotCOntrols
	if(nEx == 10.AND.nElem == 4) then
     ...
     &							jel,iOut)
		if(bPrint) then
			call Hem4_Compute_uwthetaAtEnd(DelLm,SLamdam+DelLamdai,
     ...
     &							nElem,iOut)
		if(bPrint) then
		if((iStep == 10).AND.(iNut == 1)) Then
			abc = 1
		endif
		call Compute_uwthetaAtEnd(DelLm,SLamdam+DelLamdai,
