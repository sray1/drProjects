	...
	Dimension		DropC05(4),DropC15(4),DropC25(4)	
	integer			DropC06   ,DropC16   ,DropC26   
	Dimension		DropC06(4),DropC16(4),DropC26(4)	
!---------------------------
	DATA DropC05 / 1, 6,19,23/	! Support Condition for Quartic (nQc = 5)
	DATA DropC15 / 1, 5,17,21/	! Support Condition for Quartic (nQc = 5)
	DATA DropC25 / 5,18, 9,21/	! Support Condition for Quartic (nQc = 5)
!
	DATA DropC06 / 1, 7,23,28/	! Support Condition for Quintic (nQc = 6)
