...
!-------------------------- Load
	P		= 1.D0		! Moment at 45 degree center							
!-------------------------- Geometry
	RADIUS	= 10.D0		! Radius
	DEPTH	= 0.001D0	! Depth
	WIDTH	= 1.D0		! Width
...
!		call CompareShearForce_2ELModel(A(n1a),nQc,
!     &				E,PR,RADIUS,DEPTH,WIDTH,P,A(n4),nStifEL,
!     &				A(nS),nStr,(nStr+1)/2,1,iOut)
!-------------------------------------------------------------------- 2-Elements
...
!		call CompareShearForce_2ELModel(A(n1b),nQc,
!     &				E,PR,RADIUS,DEPTH,WIDTH,P,A(n4),nStifEL,
!     &				A(nS),nStr,(nStr+1)/2,2,iOut)
		call Compare_Castig_2ELModel(E,PR,RADIUS,DEPTH,WIDTH,P,! Quick & Dirty
     &							A(n4),nStifC,nQc,2,iOut)
!--------------------------------------------------------------------
	end if
!--------------------------------------------------------------------
...
!
		...
		call Compare_DisRot_2ELModel(nQc,A(n4),nStifEL,P,
     &					A(nW),A(nU),A(nR),nDis,(nDis+1)/2,1,iOut)
!		call Compare_StrainStress_2EL(A(n1a),nQc,A(n4),nStifEL,P/2,
!     &									E,PR,RADIUS,DEPTH,WIDTH,
!     &					A(nM),A(nS),A(nA),nStr,(nStr+1)/2,nQc,1,iOut)
		call StressRecovery_2ELModel(A(n1a),nQc,A(n2a),nStifEL,
     &		E,PR,RADIUS,DEPTH,WIDTH,P,A(n4),nStifEL,
     &		A(nM),A(nS),A(nA),A(nMSA),nStr,(nStr+1)/2,nStr+1,1,iOut)
!-------------------------------------------------------------------- 2-Elements
...
!
		...
		call Compare_DisRot_2ELModel(nQc,A(n4),nStifEL,P,
     &					A(nW),A(nU),A(nR),nDis,(nDis+1)/2,2,iOut)
!		call Compare_StrainStress_2EL(A(n1b),nQc,A(n4),nStifEL,P/2,
!     &									E,PR,RADIUS,DEPTH,WIDTH,
