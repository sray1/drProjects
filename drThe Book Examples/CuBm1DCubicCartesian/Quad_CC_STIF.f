	Subroutine Quad_CC_STIF(Qc,nQc,Nel,NelType,Nint,E,PR,Thk,Stif,
     &						nStif,Iout,Trace)
!
...
!	Si = Rk(ls,Nint) 
!
!	Get Strain Displacement Matrix: B(nStif)
!
	Si = 1.0D0	! ALWAYS for Curved Beam
	Call CC_StrainDispMat(Qc,nQc,Ri,Si,B,nStif,Det,Nel,NelType,Iout)
!
!	Add to stiffness matrix
!
!	Wt = Ak(lr,Nint)*Ak(ls,Nint)*Det*TH
	Wt = Ak(lr,Nint)*Det*TH*XMult
	do 50 j = 1,nStif
