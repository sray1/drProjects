...
!	-----------------------------
		...
		Qc(1,8)		= bb + aa
!	-----------------------------
		bb			= 2.D0*(xLx - xUx)/3.D0
		aa			= xLx - bb 
!	-----------------------------
		Qc(1,9)		= bb
		Qc(1,10)	= bb + aa/3.D0
		Qc(1,11)	= bb + 2.*aa/3.D0
		Qc(1,12)	= bb + aa
!	-----------------------------
	bb			= (xLx - xUx)
	aa			= xLx - bb 
...
!	------------------------------------------ data for Bessel Tangent
		x0			= 0.0D0
		x1			= xLxTot-(xLx - 2.D0*(xLx - xUx)/3.D0)
		x2			= xLxTot
		dx0			= x1 - x0
		dx1			= x2 - x1
!	-------------------------- temporary
...
!	------------------------------
		Qc(1,13)	= x1 - shift
		Qc(1,16)	= x2 - shift
		Qc(1,14)	= Qc(1,13) + (del1/3.D0)*xm1
		Qc(1,15)	= Qc(1,16) - (del1/3.D0)*xm2
	end if
!----------------------- Zero Twist Override
!	Qc(1,6)		= 16.0D0/3.0D0
!	Qc(1,7)		= 16.0D0
