	Subroutine GeometryPlot_RAT(Qc,nDim,nQc1,nQc2,R_IN,DEPTH,ANGLE,
     &			nPtsi,nPtsj,iElem,nElems,SaveC,nPts,iOut,iOutG,W)
...
!		-------------------------------------------- Calc Coordinates		 
		Coord = 0.D0
		call Calc_Coords_at_a_Pt_RAT(Coord,Qc,W,nDim,nQc1,nQc2,
     &									ri,rj)
!		-------------------------------------------- Save
		m = m + 1
		SaveC(1,m) = Coord(1)
