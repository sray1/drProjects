	Subroutine Elem_Data_3CircumElems(cElemTyp,nCommon,Dof,mDof,
     &					nDis,mSup,nSup,
     &					Nint,nDim,nDegR,nDegS,nStifEl,iOut)
!
!	Dof(nDis)			= specified displacements at degree of freedoms	   TODOTODOTODOTODOTODOTODOTODO
