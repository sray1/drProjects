...
!-------------------------------------------------------------------------------- PALAZOTTO
!	DATA DropC06 / 1,6,7,18,25,31/	! Support Condition for Quintic (nQc = 6)   2D Hinge-Slide
!-------------------------------------------------------------------------------- Simo/Bathe also Straight
	DATA DropC06 / 1,7,13,18,25,31/	! Support Condition for Quintic (nQc = 6)   2D Cantilever
!-----------------------------------------------------------------------------------------------------
