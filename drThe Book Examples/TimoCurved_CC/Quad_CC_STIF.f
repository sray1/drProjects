	Subroutine Quad_CC_STIF(Qc,nQc,Nel,NelType,Nint,E,PR,
...
!
	Call CC_StrainDispMat(Qc,nQc,Ri,Radius,B,nStif,Det,
     &									Nel,NelType,Iout)
!
...
!	Pause
  110	continue
	return
!
 1000 format("QC(2,4): Elem# =",I4/
     &        2(I5,5X,4(f10.6,1X)/) )
!
 1010 format("Full Stiffness Matrix:Stif(",I2,",",I2,")"/)
 1020 format(I5/(2(6(f10.6,1X)/)/))
	return
	end   		