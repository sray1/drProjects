# Microsoft Developer Studio Project File - Name="3DCartCuLn" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "3DCartCuLn.mak".
!MESSAGE 
...
# PROP Target_Dir ""
# ADD BASE F90 /compile_only /include:"Release/" /libs:qwins /nologo /warn:nofileopt
# ADD F90 /compile_only /include:"Release/" /libs:qwins /nologo /warn:nofileopt
...
# PROP Target_Dir ""
# ADD BASE F90 /check:bounds /compile_only /debug:full /include:"Debug/" /libs:qwins /nologo /traceback /warn:argument_checking /warn:nofileopt
# ADD F90 /check:bounds /compile_only /debug:full /include:"Debug/" /libs:qwins /nologo /traceback /warn:argument_checking /warn:nofileopt
...
# ADD LINK32 kernel32.lib smathd.lib sf90mp.lib /nologo /stack:0x3d0900 /entry:"WinMainCRTStartup" /subsystem:windows /incremental:no /debug /machine:I386 /nodefaultlib:"dfconsol.lib" /out:"Debug/TestRGeq1.exe" /pdbtype:sept
...
# Name "3DCartCuLn - Win32 Release"
# Name "3DCartCuLn - Win32 Debug"
