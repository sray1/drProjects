	Subroutine Compute_ElementReactions_2(Stif,D,nStif,FI,FJ,nF,Qc,nQc,P,
     &									Radius,Nel,iOut)
!
...
!--------------------------------------------------------- Curvilinear
	...
	sumM	= 0.D0
	do 60 j = 1,3
   	sumF	= sumF + Axes(i,j)*FI(j)
   60	sumM	= sumM + Axes(i,j)*FI(j+3)
	Fc(i)	= sumF
	Fc(i+3)	= sumM
   70 continue		
!	/////////////////////////////////////////////////// 
...
!--------------------------------------------------------- Curvilinear
	...
	sumM	= 0.D0
	do 61 j = 1,3
   	sumF	= sumF + Axes(i,j)*FJ(j)
   61	sumM	= sumM + Axes(i,j)*FJ(j+3)
	Fc(i)	= sumF
	Fc(i+3)	= sumM
   71 continue		
!	/////////////////////////////////////////////////// 
